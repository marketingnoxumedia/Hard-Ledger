...
// Car wash "Wall Street rollup" reel. Durations from ElevenLabs word timestamps
// at +6% pace. Total 1658 frames = ~55.1s. Reuses shared clips from media/ & yahoo/.
const SCENES: SceneDef[] = [
  {dur: 120, kind: 'hook', text: 'Wall Street is quietly|buying a business you|drive through in minutes.', kicker: 'Hiding in plain sight', highlights: ['minutes'], size: 78, media: {src: 'carwash/clip_wash.mp4', type: 'video', effect: 'in'}},
  {dur: 120, kind: 'lines', text: 'No app.|No founder story.|Just soap, water,|a monthly charge.', highlights: ['monthly'], reveal: [0, 26, 52, 80], media: {src: 'carwash/p_5693653.jpeg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', text: 'Car washes stopped|charging per wash.', highlights: ['wash'], size: 88},
  {dur: 61, kind: 'text', text: 'They sell unlimited|monthly memberships.', highlights: ['memberships'], size: 84, media: {src: 'carwash/p_32665242.jpeg', type: 'img', effect: 'in'}},
  {dur: 104, kind: 'text', text: 'A one-off service|became recurring.', highlights: ['recurring'], size: 90},
  {dur: 81, kind: 'text', text: 'Members pay every month —|wash or not.', highlights: ['month'], size: 84, media: {src: 'carwash/clip_payment.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'The cost per wash|is low.', highlights: ['low'], size: 94},
  {dur: 65, kind: 'text', text: 'The land underneath|holds its value.', highlights: ['land'], size: 88, media: {src: 'carwash/clip_land.mp4', type: 'video', effect: 'in'}},
  {dur: 112, kind: 'text', enter: 'slideL', text: 'It isn’t the wash.|It’s the contract|behind it.', highlights: ['contract'], size: 84, media: {src: 'carwash/clip_contract.mp4', type: 'video', effect: 'in'}},
  {dur: 128, kind: 'text', enter: 'zoom', text: 'A weather-dependent purchase|became predictable|monthly cash.', highlights: ['predictable'], size: 76, media: {src: 'carwash/clip_cash.mp4', type: 'video', effect: 'in'}},
  {dur: 116, kind: 'text', text: 'The cash flow a buyer|pays a premium for.', highlights: ['premium'], size: 84, media: {src: 'carwash/clip_premium.mp4', type: 'video', effect: 'out'}},
  {dur: 89, kind: 'text', enter: 'slideR', text: 'Private equity is|rolling up independent|car washes.', highlights: ['rolling'], size: 80, media: {src: 'carwash/clip_district.mp4', type: 'video', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'Into large chains.', highlights: ['chains'], size: 100},
  {dur: 97, kind: 'stat', enter: 'zoom', stat: {pre: 'You are buying', value: 2, post: 'assets in one purchase'}},
  {dur: 110, kind: 'lines', text: 'The membership base.|The real estate|under it.', highlights: ['real', 'estate'], reveal: [0, 30, 55], media: {src: 'carwash/clip_realestate.mp4', type: 'video', effect: 'out'}},
  {dur: 52, kind: 'impact', text: 'Recurring|changes everything.', redBg: true},
  {dur: 144, kind: 'text', text: 'A car wash is a|subscription|attached to land.', highlights: ['subscription'], size: 84},
  {dur: 86, kind: 'text', text: 'The model Wall Street|is consolidating.', highlights: ['consolidating'], size: 84, media: {src: 'carwash/p_8878493.jpeg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 120, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 382, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 619, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 796, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 924, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1040, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 1169, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1266, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 1376, src: 'media/sfx_impact.mp3', vol: 0.7},
  {at: 1572, src: 'media/sfx_whoosh.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The car wash play</span>
      </div>
...
// ---------------------------------------------------------------------------
export const CarWashReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('carwash/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('carwash/music.mp3')}
