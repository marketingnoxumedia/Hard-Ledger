...
const SCENES: SceneDef[] = [
  ...
  {dur: 81, kind: 'text', text: 'Members pay every month —|wash or not.', highlights: ['month'], size: 84},
  {dur: 52, kind: 'text', text: 'The cost per wash|is low.', highlights: ['low'], size: 94},
  {dur: 65, kind: 'text', text: 'The land underneath|holds its value.', highlights: ['land'], size: 88, media: {src: 'media/p_3997060.jpeg', type: 'img', effect: 'in'}},
