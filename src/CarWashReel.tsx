...
const SCENES: SceneDef[] = [
  ...
  {dur: 112, kind: 'text', enter: 'slideL', text: 'It isn’t the wash.|It’s the contract|behind it.', highlights: ['contract'], size: 84, media: {src: 'yahoo/p_8428059.jpeg', type: 'img', effect: 'in'}},
  {dur: 128, kind: 'text', enter: 'zoom', text: 'A weather-dependent purchase|became predictable|monthly cash.', highlights: ['predictable'], size: 76, media: {src: 'media/clip_counting.mp4', type: 'video', effect: 'in'}},
  {dur: 116, kind: 'text', text: 'The cash flow a buyer|pays a premium for.', highlights: ['premium'], size: 84, media: {src: 'media/p_cash_briefcase.jpeg', type: 'img', effect: 'out'}},
  {dur: 89, kind: 'text', enter: 'slideR', text: 'Private equity is|rolling up independent|car washes.', highlights: ['rolling'], size: 80, media: {src: 'media/clip_industrial.mp4', type: 'video', effect: 'in'}},
  ...
  {dur: 110, kind: 'lines', text: 'The membership base.|The real estate|under it.', highlights: ['real', 'estate'], reveal: [0, 30, 55], media: {src: 'media/clip_suburb.mp4', type: 'video', effect: 'out'}},
