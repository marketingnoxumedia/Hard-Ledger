...
// ---------------------------------------------------------------------------
// "The cloud is the business" reel — the long-form Amazon segment story. You
// think of Amazon as a store, and the store is most of what it sells — but less
// than half of what it earns. Its own segment reporting flips the picture:
// retail (North America + International) brings in over 80% of revenue while AWS
// is under a fifth; on operating income it reverses — AWS earns more than half
// of all operating income on that small slice of sales. Retail does make money
// now, but AWS earns far out of proportion to its size, so investors price
// Amazon on the segment that earns, not the one that's visible. The store is the
// front; the cloud is the business. The voiceover runs continuously with no dead
// air and scene durations sit on its exact spoken-word timestamps (ElevenLabs
// alignment) at +6% pace — total 1282 frames = ~43s. Mixes three video clips
// (shopping, a busy store, a server room) with stills; two segment stats
// (>80% / >50%), the "on profit, it flips" red impact card, and a closing
// <20%-of-sales vs >50%-of-profit comparison. Every background is sourced fresh
// for this reel (hard rule).
//
// NOTE (unverified): this reel names a real company (Amazon, NASDAQ: AMZN) and
// characterises its segment economics — retail >80% of revenue, AWS under a
// fifth of revenue but >50% of operating income — as stated in the client
// script (attributed to Amazon's own segment reporting). Rendered as written and
// NOT independently verified; confirm against the latest 10-K before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 85, kind: 'hook', text: 'A company you think|of as a store.', kicker: 'The cloud is the business', highlights: ['store'], size: 74, media: {src: 'aws/p_12805817.jpg', type: 'img', effect: 'in'}},
  {dur: 91, kind: 'text', text: 'Most of what|it sells.', highlights: ['most'], size: 84, media: {src: 'aws/clip_shop.mp4', type: 'video', effect: 'in'}},
  {dur: 101, kind: 'text', text: 'Less than half|of what it earns.', highlights: ['half'], size: 78},
  {dur: 32, kind: 'text', text: 'It\'s|Amazon.', highlights: ['amazon'], size: 100, media: {src: 'aws/p_6170463.jpg', type: 'img', effect: 'in'}},
  {dur: 108, kind: 'text', enter: 'slideL', text: 'Its own segment|reporting.', highlights: ['segment'], size: 80, media: {src: 'aws/p_7947849.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'text', text: 'Retail: North America|and International.', highlights: ['retail'], size: 68, media: {src: 'aws/clip_store.mp4', type: 'video', effect: 'in'}},
  {dur: 108, kind: 'stat', stat: {pre: 'Retail, of revenue', prefix: '>', value: 80, suffix: '%'}},
  {dur: 31, kind: 'text', text: 'AWS: under|a fifth.', highlights: ['fifth'], size: 88, media: {src: 'aws/p_37730211.jpg', type: 'img', effect: 'in'}},
  {dur: 79, kind: 'impact', text: 'On profit,|it flips.', redBg: true},
  {dur: 63, kind: 'stat', stat: {pre: 'AWS, of operating income', prefix: '>', value: 50, suffix: '%'}},
  {dur: 57, kind: 'text', text: 'On that small|slice of sales.', highlights: ['slice'], size: 80},
  {dur: 85, kind: 'text', text: 'Retail makes|money now.', highlights: ['money'], size: 84},
  {dur: 82, kind: 'text', enter: 'slideR', text: 'AWS earns far out|of proportion.', highlights: ['proportion'], size: 76, media: {src: 'aws/p_17323801.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'text', text: 'Priced on the|segment that earns.', highlights: ['earns'], size: 76},
  {dur: 38, kind: 'text', text: 'Not the one|that\'s visible.', highlights: ['visible'], size: 84},
  {dur: 34, kind: 'text', text: 'The store|is the front.', highlights: ['front'], size: 88},
  {dur: 44, kind: 'text', text: 'The cloud|is the business.', highlights: ['business'], size: 88, media: {src: 'aws/clip_servers.mp4', type: 'video', effect: 'in'}},
  {dur: 92, kind: 'compare', compare: {a: {value: 20, prefix: '<', suffix: '%', label: 'of sales'}, b: {value: 50, prefix: '>', suffix: '%', label: 'of profit'}, note: 'AWS · Amazon segment reporting'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 277, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 417, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 494, src: 'media/sfx_whoosh.mp3', vol: 0.35},
  {at: 602, src: 'media/sfx_impact.mp3', vol: 0.62},
  {at: 633, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 639, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1146, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1190, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1196, src: 'media/sfx_chaching.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The cloud is the business</span>
      </div>
...
export const AwsReel: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('aws/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('aws/music.mp3')}
