...
// ---------------------------------------------------------------------------
// "The gravel moat" reel — Vulcan Materials, the largest US aggregates producer.
// The moat is physics: crushed stone is worth so little per tonne and costs so
// much to move that a rival two counties away can't compete, and permitting
// freezes the quarry map in place. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1364 frames = ~45.5s.
// The red `impact` card ("weight is the whole moat") sits mid-reel; the reel
// ends on a quarry aerial ("the location is priceless"), not the red card.
...
const SCENES: SceneDef[] = [
  {dur: 57, kind: 'hook', text: 'The most durable|monopoly in America.', kicker: 'The gravel moat', highlights: ['durable'], size: 78, media: {src: 'vulcan/p_33122147.jpg', type: 'img', effect: 'in'}},
  {dur: 97, kind: 'text', text: 'Not technology.|Not patents.', highlights: ['patents'], size: 84, media: {src: 'vulcan/p_237950.jpg', type: 'img', effect: 'in'}},
  {dur: 37, kind: 'text', text: 'Just a pile|of gravel.', highlights: ['gravel'], size: 92, media: {src: 'vulcan/p_5799727.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'text', enter: 'slideL', text: 'Too heavy to|drive very far.', highlights: ['heavy'], size: 82, media: {src: 'vulcan/p_34150285.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'stat', stat: {pre: 'Worth almost', prefix: '$', value: 8, suffix: 'B', post: 'a year'}, media: {src: 'vulcan/p_33122148.jpg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', text: 'Vulcan Materials.|The largest|US producer.', highlights: ['Vulcan'], size: 74, media: {src: 'vulcan/p_6553283.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'Construction|aggregates.', highlights: ['aggregates'], size: 88, media: {src: 'vulcan/p_26925731.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'Crushed stone,|sand and gravel.', highlights: ['stone'], size: 80, media: {src: 'vulcan/p_31096912.jpg', type: 'img', effect: 'panL'}},
  {dur: 46, kind: 'text', text: 'Under every|road and building.', highlights: ['every'], size: 80, media: {src: 'vulcan/p_37820986.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'impact', text: 'Weight is|the whole moat.', redBg: true},
  {dur: 42, kind: 'text', text: 'Worth so little|per tonne.', highlights: ['little'], size: 84},
  {dur: 58, kind: 'text', enter: 'slideR', text: 'And costs so|much to move.', highlights: ['move'], size: 82, media: {src: 'vulcan/p_35177799.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'A rival two|counties away…', highlights: ['two'], size: 82, media: {src: 'vulcan/p_29181420.jpg', type: 'img', effect: 'in'}},
  {dur: 91, kind: 'text', text: '…can\'t compete|on price.', highlights: ['price'], size: 80, media: {src: 'vulcan/p_14704774.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'text', text: 'Permitting|freezes the map.', highlights: ['freezes'], size: 84, media: {src: 'vulcan/p_31067412.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', enter: 'zoom', text: 'The quarries today|are the quarries|of tomorrow.', highlights: ['tomorrow'], size: 74, media: {src: 'vulcan/p_36236254.jpg', type: 'img', effect: 'panR'}},
  {dur: 94, kind: 'text', text: 'The largest producer,|with pits next|to demand.', highlights: ['pits'], size: 74, media: {src: 'vulcan/p_288096.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'Right next|to demand.', highlights: ['demand'], size: 90, media: {src: 'vulcan/p_30617023.jpg', type: 'img', effect: 'in'}},
  {dur: 85, kind: 'stat', stat: {pre: 'Revenue', prefix: '$', value: 7.9, decimals: 1, suffix: 'B'}, media: {src: 'vulcan/p_33122152.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'stat', stat: {pre: 'Net income', prefix: '$', value: 1, suffix: 'B'}},
  {dur: 40, kind: 'text', text: 'The product|is dirt cheap.', highlights: ['cheap'], size: 88, media: {src: 'vulcan/p_4599912.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', enter: 'zoom', text: 'The location|is priceless.', highlights: ['priceless'], size: 84, media: {src: 'vulcan/p_6542371.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 269, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 319, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 542, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 845, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1137, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1222, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1304, src: 'media/sfx_impact.mp3', vol: 0.55},
];
...
const SceneOutro: React.FC = () => {
  ...
  const {fps} = useVideoConfig();
  const parts = [
    {t: 'Dirt-cheap product.', red: false},
    {t: 'Priceless ground.', red: false},
    {t: 'Unbeatable.', red: true},
  ];
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center'}}>
        ...
        {parts.map((p, i) => {
          ...
          return (
            <span key={i} style={{fontFamily: HEAD, fontSize: p.red ? 150 : 116, textTransform: 'uppercase', letterSpacing: 1, color: C.ink, opacity: s, transform: `translateY(${interpolate(s, [0, 1], [34, 0])}px)`}}>
              {p.red ? (<span style={{color: C.red, textShadow: SH}}>Unbeatable.</span>) : p.t}
            </span>
          );
        })}
      </div>
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The gravel moat</span>
      </div>
...
// ---------------------------------------------------------------------------
export const VulcanReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('vulcan/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('vulcan/music.mp3')}
