...
// ---------------------------------------------------------------------------
// "Own the landfill" reel — Waste Management. Durations placed on exact
// spoken-word timestamps (ElevenLabs alignment) at +6% pace. Total 1489 frames
// = ~49.6s. `enter` adds a transition on some cuts. Every scene uses a distinct
// background sourced fresh for this reel — no footage is shared with any other
// reel (see the skill's hard rule).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 125, kind: 'hook', text: 'America’s most|defensible business|isn’t tech.', kicker: 'The permit moat', highlights: ['defensible'], size: 76, media: {src: 'waste/p_3174347.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', enter: 'slideL', text: 'It’s a hole|in the ground.', highlights: ['hole'], size: 90, media: {src: 'waste/p_4454064.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'stat', stat: {pre: 'It throws off', prefix: '$', value: 25, suffix: 'B', post: 'a year'}, media: {src: 'waste/p_5424849.jpg', type: 'img', effect: 'in'}},
  {dur: 119, kind: 'text', text: 'Waste Management|collects the trash.', highlights: ['trash'], size: 78, media: {src: 'waste/clip_truck.mp4', type: 'video', effect: 'in'}},
  {dur: 56, kind: 'text', enter: 'slideR', text: 'And owns the landfills|it dumps into.', highlights: ['owns'], size: 78, media: {src: 'waste/clip_dump.mp4', type: 'video', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'The barrier|isn’t the truck.', highlights: ['truck'], size: 84, media: {src: 'waste/p_35436630.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'It’s the|permit.', highlights: ['permit'], size: 110},
  {dur: 127, kind: 'text', enter: 'slideL', text: 'Rules make new landfills|near impossible|to open.', highlights: ['impossible'], size: 74, media: {src: 'waste/p_18687845.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'text', text: 'Whoever owns the hole|owns the market.', highlights: ['market'], size: 76, media: {src: 'waste/p_3181031.jpg', type: 'img', effect: 'panL'}},
  {dur: 63, kind: 'text', text: 'Rivals must haul|waste further.', highlights: ['further'], size: 82, media: {src: 'waste/p_20684574.jpg', type: 'img', effect: 'in'}},
  {dur: 123, kind: 'text', enter: 'slideL', text: 'Raising their cost|on every|single load.', highlights: ['cost'], size: 76, media: {src: 'waste/p_15978610.jpg', type: 'img', effect: 'in'}},
  {dur: 108, kind: 'lines', text: 'Routes.|Trucks.|Landfills.', highlights: ['landfills'], reveal: [0, 26, 52], media: {src: 'waste/p_8783849.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Infrastructure a rival|can’t rebuild.', highlights: ['rebuild'], size: 78, media: {src: 'waste/p_128421.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'Twenty-five billion|a year in revenue.', highlights: ['billion'], size: 80, media: {src: 'waste/p_5441305.jpg', type: 'img', effect: 'panR'}},
  {dur: 58, kind: 'stat', stat: {pre: 'Operating margin', value: 17, suffix: '%', bar: 17}},
  {dur: 65, kind: 'stat', stat: {pre: 'EBITDA margin', value: 30, suffix: '%', post: 'and up', bar: 30}},
  {dur: 78, kind: 'stat', stat: {pre: 'Dividend hikes', value: 20, suffix: '+ yrs', post: 'in a row'}},
  {dur: 27, kind: 'impact', text: 'Own the|landfill.', redBg: true},
  {dur: 140, kind: 'text', enter: 'zoom', text: 'Permits, not equipment,|are the real barrier —|nearly impossible now.', highlights: ['permits'], size: 72, media: {src: 'waste/p_9858904.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 170, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 372, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 471, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 702, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 888, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1056, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1179, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1322, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1349, src: 'media/sfx_whoosh.mp3', vol: 0.45},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Own the landfill</span>
      </div>
...
// ---------------------------------------------------------------------------
export const WasteReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('waste/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('waste/music.mp3')}
