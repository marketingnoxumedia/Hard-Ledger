...
// ---------------------------------------------------------------------------
// "Just sit still" reel — index investing vs the pros, framed off a punchy hook
// (a third, more provocative take on the topic alongside the existing IndexReel and
// ActiveReel; publish only one of the three, or space them far apart). Why do 9 in 10
// professional investors lose to a strategy that takes zero skill? The broad US market
// has returned ~10%/yr for a century (~7% real); at ~10% money doubles roughly every 7
// years ($10K → $20K → $40K with nothing added); yet over 15 years about 90% of pro
// stock funds fail to beat that simple index — the experts, with all their research,
// mostly lose to the average. You don't beat the market by being clever, you capture it
// by staying in: the horizon does the heavy lifting and the real enemy is impatience,
// not stock-picking. The return was always there; the hard part was sitting still.
...
// long-run US equity return, rule-of-72 doubling, and the "~90% of active funds trail
// the index over 15 years" claim (SPIVA-style) are widely cited but approximate —
// verify against S&P/SPIVA sources before publishing; general market commentary, not
// investment advice. Imagery is generic (no exchange/broker logos, no tickers, no flags).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  ...
  {dur: 74, kind: 'stat', stat: {pre: 'After inflation', value: 7, suffix: '%', post: 'A year'}, media: {src: 'still/p_inflation.jpg', type: 'img', effect: 'in'}},
  {dur: 132, kind: 'lines', text: 'No picking.|No timing.|No talent.', highlights: ['talent']},
  {dur: 45, kind: 'text', text: 'Money doubles|every 7 years.', highlights: ['7'], size: 90, media: {src: 'still/p_growth.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: '$10K becomes|$20K.', highlights: ['$20k'], size: 96, media: {src: 'still/p_stacks.jpg', type: 'img', effect: 'in'}},
  {dur: 37, kind: 'text', text: '$20K becomes|$40K.', highlights: ['$40k'], size: 96},
  {dur: 56, kind: 'text', text: 'Without adding|a cent.', highlights: ['cent'], size: 96, media: {src: 'still/p_wallet.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'text', text: 'Now, the part|that stings.', highlights: ['stings'], size: 92},
  {dur: 104, kind: 'stat', stat: {pre: 'Over 15 years', value: 90, suffix: '%', post: 'Of pro funds fail'}, media: {src: 'still/p_office.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'Fail to beat|the index.', highlights: ['index'], size: 96},
  {dur: 124, kind: 'text', enter: 'slideL', text: 'The experts lose|to the average.', highlights: ['average'], size: 86, media: {src: 'still/p_analysts.jpg', type: 'img', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'You don\'t win|by being clever.', highlights: ['clever'], size: 88},
  {dur: 49, kind: 'text', enter: 'slideL', text: 'You win|by staying in.', highlights: ['staying'], size: 96, media: {src: 'still/v_hold.mp4', type: 'video', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'The horizon does|the heavy lifting.', highlights: ['horizon'], size: 84, media: {src: 'still/p_horizon.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'impact', text: 'The real enemy|is impatience.', redBg: true},
  {dur: 51, kind: 'text', text: 'The return was|always there.', highlights: ['return'], size: 90, media: {src: 'still/p_uptrend.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'The hard part was|never the strategy.', highlights: ['strategy'], size: 84, media: {src: 'still/p_calm.jpg', type: 'img', effect: 'in'}},
  {dur: 36, kind: 'text', text: 'It was|sitting still.', highlights: ['sitting'], size: 100},
  {dur: 48, kind: 'text', text: '9 in 10 pros|can\'t win.', highlights: ['9'], size: 92, media: {src: 'still/p_crowd.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', enter: 'slideL', text: 'They can\'t beat|the average.', highlights: ['average'], size: 88, media: {src: 'still/p_average.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', enter: 'zoom', text: 'So why think|you\'re smarter?', highlights: ['smarter?'], size: 90, media: {src: 'still/v_close.mp4', type: 'video', effect: 'in'}},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Just sit still</span>
      </div>
...
// ---------------------------------------------------------------------------
export const StillReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('still/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('still/music.mp3')}
