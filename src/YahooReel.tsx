...
// Yahoo "know when to sell" reel. Durations from ElevenLabs word timestamps at
// +6% pace. Total 1577 frames = ~52.4s. Reuses shared finance clips from media/.
const SCENES: SceneDef[] = [
  {dur: 134, kind: 'hook', text: 'In 2008, a company|turned down|forty-four billion dollars.', kicker: 'Know when to sell', highlights: ['billion'], size: 84, media: {src: 'yahoo/clip_hook.mp4', type: 'video', effect: 'in'}},
  {dur: 79, kind: 'text', text: 'Nine years later,|it sold for|a tenth of that.', highlights: ['tenth'], size: 88},
  {dur: 60, kind: 'text', text: 'Yahoo was a|faded internet giant.', highlights: ['faded'], size: 90, media: {src: 'yahoo/p_37148217.jpeg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Already|past its peak.', highlights: ['peak'], size: 104, media: {src: 'yahoo/p_8910505.jpeg', type: 'img', effect: 'out'}},
  {dur: 127, kind: 'stat', enter: 'zoom', stat: {pre: 'Microsoft offered', prefix: '$', value: 44.6, decimals: 1, suffix: 'B'}, media: {src: 'yahoo/clip_cashstacks.mp4', type: 'video', effect: 'in'}},
  {dur: 64, kind: 'text', text: 'The board rejected the bid|as too low.', highlights: ['rejected'], size: 86, media: {src: 'yahoo/p_8428059.jpeg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', text: 'Betting it could|do better alone.', highlights: ['alone'], size: 94},
  {dur: 51, kind: 'text', text: 'Boards reject|first offers.', highlights: ['first'], size: 96},
  {dur: 52, kind: 'text', text: 'The bid looked|opportunistic.', highlights: ['opportunistic'], size: 90},
  {dur: 125, kind: 'text', enter: 'slideL', text: 'A turnaround —|plus its Asian assets —|worth more.', highlights: ['assets'], size: 78, media: {src: 'yahoo/p_28608382.jpeg', type: 'img', effect: 'in'}},
  {dur: 98, kind: 'text', text: 'It required winning|search, then mobile.', highlights: ['mobile'], size: 86, media: {src: 'yahoo/p_246684.jpeg', type: 'img', effect: 'panR'}},
  {dur: 46, kind: 'text', text: 'Battles it was|already losing.', highlights: ['losing'], size: 92, media: {src: 'yahoo/clip_decline.mp4', type: 'video', effect: 'in'}},
  {dur: 114, kind: 'text', text: 'Its value kept eroding|through the exact era|it failed to win.', highlights: ['eroding'], size: 80},
  {dur: 167, kind: 'stat', enter: 'zoom', stat: {pre: 'Sold to Verizon in 2017', prefix: '$', value: 4.8, decimals: 1, suffix: 'B'}, media: {src: 'yahoo/clip_counting2.mp4', type: 'video', effect: 'out'}},
  {dur: 74, kind: 'text', text: 'A tenth of the offer|it had rejected.', highlights: ['tenth'], size: 88, media: {src: 'yahoo/clip_coins.mp4', type: 'video', effect: 'in'}},
  {dur: 26, kind: 'impact', text: 'Know when|to sell.', redBg: true},
  {dur: 91, kind: 'text', text: 'Holding out for more|only works while|the business is rising.', highlights: ['rising'], size: 80},
  {dur: 79, kind: 'text', enter: 'slideR', text: 'Yahoo mistook|a peak offer|for a floor.', highlights: ['floor'], size: 84, media: {src: 'yahoo/p_31511694.jpeg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'The market|doesn’t wait.', highlights: ['wait'], size: 108},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 134, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 442, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 506, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 711, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 980, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 1094, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 1335, src: 'media/sfx_impact.mp3', vol: 0.7},
  {at: 1361, src: 'media/sfx_whoosh.mp3', vol: 0.5},
  {at: 1452, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1531, src: 'media/sfx_whoosh.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Know when to sell</span>
      </div>
...
// ---------------------------------------------------------------------------
export const YahooReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('yahoo/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('yahoo/music.mp3')}
