...
const SCENES: SceneDef[] = [
  ...
  {dur: 127, kind: 'stat', enter: 'zoom', stat: {pre: 'Microsoft offered', prefix: '$', value: 44.6, decimals: 1, suffix: 'B'}, media: {src: 'media/clip_counting.mp4', type: 'video', effect: 'in'}},
  ...
  {dur: 46, kind: 'text', text: 'Battles it was|already losing.', highlights: ['losing'], size: 92, media: {src: 'media/clip_chart.mp4', type: 'video', effect: 'in'}},
  {dur: 114, kind: 'text', text: 'Its value kept eroding|through the exact era|it failed to win.', highlights: ['eroding'], size: 80},
  {dur: 167, kind: 'stat', enter: 'zoom', stat: {pre: 'Sold to Verizon in 2017', prefix: '$', value: 4.8, decimals: 1, suffix: 'B'}, media: {src: 'media/clip_usdollars.mp4', type: 'video', effect: 'out'}},
  {dur: 74, kind: 'text', text: 'A tenth of the offer|it had rejected.', highlights: ['tenth'], size: 88, media: {src: 'media/p_cash_bills.jpeg', type: 'img', effect: 'in'}},
