...
// ---------------------------------------------------------------------------
// "The hours myth" reel (curiosity-hook variant of PerHourReel — a fifth take on
// hours-worked vs output-per-hour, opening on a question instead of the number).
// "Want to know why the country that works the most hours produces the LEAST per
// hour?" Germany works ~1,343 hours a year, Mexico ~2,207, and Germany still produces
// more per hour — a gap of about 864 hours, roughly a hundred extra eight-hour days.
// Across ~40 developed economies the pattern holds: the more a country works on
// average, the less it tends to make per hour (illustratively ~$10 less output per
// hour for every extra 100 annual hours). Hours measure effort, not output; past a
// point more time in the chair adds fatigue, not value. The lever was never the length
// of the day — it's what gets made inside each hour. Five count-up stats (1,343 /
...
// OECD publishes) and the "~$10 per extra 100 hours" correlation is a stylized
// characterization — verify exact OECD numbers before publishing. Imagery is kept
// neutral (no flags / no country-identifying footage): countries are named in the VO
// and labelled on the stats only. This is a near-duplicate of PerHourReel (same body,
// curiosity hook) — publish only one, or space them well apart.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  ...
  {dur: 55, kind: 'stat', stat: {pre: 'The gap', value: 864, post: 'Hours a year'}, media: {src: 'hardest/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 124, kind: 'text', text: 'Roughly 100 extra|eight-hour days.', highlights: ['100'], size: 88, media: {src: 'hardest/p_planner.jpg', type: 'img', effect: 'in'}},
  {dur: 113, kind: 'text', enter: 'slideL', text: 'A hundred more days,|less per hour.', highlights: ['less'], size: 88, media: {src: 'hardest/v_commute.mp4', type: 'video', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'Not two countries|cherry-picked.', highlights: ['cherry-picked'], size: 88, media: {src: 'hardest/p_data.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'stat', stat: {pre: 'Line them up', value: 40, post: 'Developed economies'}, media: {src: 'hardest/p_charts.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'text', enter: 'slideL', text: 'And the pattern|holds tight.', highlights: ['pattern'], size: 90, media: {src: 'hardest/v_trend.mp4', type: 'video', effect: 'in'}},
  {dur: 135, kind: 'text', text: 'More hours worked,|less made per hour.', highlights: ['less'], size: 86, media: {src: 'hardest/p_decline.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'stat', stat: {prefix: '$', pre: 'Every extra 100 hours', value: 10, post: 'Less output per hour'}, media: {src: 'hardest/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 88, kind: 'text', enter: 'slideL', text: 'Hours measure effort,|not output.', highlights: ['effort'], size: 88, media: {src: 'hardest/v_treadmill.mp4', type: 'video', effect: 'in'}},
  {dur: 89, kind: 'text', text: 'More time in the chair|adds fatigue.', highlights: ['fatigue'], size: 86, media: {src: 'hardest/p_tired.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'impact', text: 'The lever was never|the length of the day.', redBg: true},
  {dur: 95, kind: 'text', enter: 'slideL', text: 'It\'s what gets made|inside each hour.', highlights: ['made'], size: 88, media: {src: 'hardest/v_craft.mp4', type: 'video', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'The hardest workers|make the least.', highlights: ['least'], size: 88, media: {src: 'hardest/p_overwork.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', enter: 'zoom', text: 'What were those|extra days buying?', highlights: ['extra'], size: 88, media: {src: 'hardest/v_close.mp4', type: 'video', effect: 'in'}},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The hours myth</span>
      </div>
...
// ---------------------------------------------------------------------------
export const HardestReel: React.FC = () => {
  const frame = useCurrentFrame();
