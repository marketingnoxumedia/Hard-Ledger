...
// ---------------------------------------------------------------------------
// "The depreciation curve" reel — a new car loses about a fifth of its value the
// instant you own it, faster than fuel/insurance/repairs: a $40K car is worth about
// $32K within a year, so driving it off the lot quietly spends ~$8K in year-one
// depreciation. The drop is steepest first — ~20% after year one, ~60% after five,
// worth less than half its sticker before the warranty ends — so a 2-3 year old car
// has already taken the worst of the fall while keeping most of its life. New isn't
// a cost, it's a luxury; the depreciation curve is the real price tag. Durations
// placed on exact spoken-word timestamps (ElevenLabs alignment) at +6% pace. Total
// 1750 frames = ~58.3s. `enter` adds a transition on some cuts. Every scene uses a
// distinct background sourced fresh for this reel — no footage is shared with any
// other reel (see the skill's hard rule). Three count-up stats ($8K year-one drop,
// then 20% and 60% with bars for the curve), two black beats, a red "new isn't a
// cost / it's a luxury" card near the tail, and a close on footage rather than the
// red card. Figures are round illustrations, not verified data.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 85, kind: 'hook', text: 'A purchase that|loses a fifth.', kicker: 'The depreciation curve', highlights: ['fifth'], size: 92, media: {src: 'car/v_hook.mp4', type: 'video', effect: 'in'}},
  {dur: 52, kind: 'text', enter: 'slideR', text: 'The instant it|becomes yours.', highlights: ['instant'], size: 90, media: {src: 'car/p_keys.jpg', type: 'img', effect: 'in'}},
  {dur: 110, kind: 'text', text: 'Faster than fuel|or repairs.', highlights: ['faster'], size: 90, media: {src: 'car/p_fuel.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'And almost nobody|counts it.', highlights: ['nobody'], size: 92},
  {dur: 46, kind: 'text', text: "It's a|new car.", highlights: ['car'], size: 108, media: {src: 'car/p_newcar.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', text: 'Twenty percent.|Year one.', highlights: ['twenty'], size: 96, media: {src: 'car/p_showroom.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: 'A $40K car|today.', highlights: ['$40k'], size: 94, media: {src: 'car/p_sticker.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'A $32K car|in a year.', highlights: ['$32k'], size: 94, media: {src: 'car/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 91, kind: 'text', enter: 'slideL', text: 'Within twelve|months.', highlights: ['twelve'], size: 96, media: {src: 'car/p_pricetag.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'text', text: 'Drive it off|the lot.', highlights: ['lot'], size: 94, media: {src: 'car/v_driveoff.mp4', type: 'video', effect: 'in'}},
  {dur: 123, kind: 'stat', stat: {pre: 'You just spent', prefix: '$', value: 8, suffix: 'K', post: 'in year-one depreciation'}},
  {dur: 52, kind: 'text', text: 'More than years|of fuel.', highlights: ['years'], size: 90, media: {src: 'car/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'The steepest part|comes first.', highlights: ['steepest'], size: 88, media: {src: 'car/p_chart.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'stat', stat: {pre: 'After one year', value: 20, suffix: '%', post: 'down', bar: 20}},
  {dur: 94, kind: 'stat', stat: {pre: 'After five years', value: 60, suffix: '%', post: 'down', bar: 60}},
  {dur: 52, kind: 'text', text: 'Less than half|its sticker.', highlights: ['half'], size: 90, media: {src: 'car/p_usedlot.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'text', text: 'Before the warranty|even ends.', highlights: ['warranty'], size: 86, media: {src: 'car/p_doc.jpg', type: 'img', effect: 'in'}},
  {dur: 106, kind: 'text', enter: 'slideL', text: 'It leaves where|you can\'t see.', highlights: ['leaves'], size: 86, media: {src: 'car/p_odometer.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'A used car is|a different deal.', highlights: ['different'], size: 86, media: {src: 'car/p_used.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'It took the worst|of the fall.', highlights: ['worst'], size: 88, media: {src: 'car/p_downhill.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'Kept most|of its life.', highlights: ['life'], size: 92, media: {src: 'car/p_engine.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'Paid for the|new smell.', highlights: ['smell'], size: 92, media: {src: 'car/p_interior.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'impact', text: "New isn't a cost.|It's a luxury.", redBg: true},
  {dur: 73, kind: 'text', text: 'The curve is|the real price tag.', highlights: ['price'], size: 86},
  {dur: 56, kind: 'text', text: '$40K, driven|off the lot.', highlights: ['$40k'], size: 90, media: {src: 'car/p_exit.jpg', type: 'img', effect: 'in'}},
  {dur: 58, kind: 'text', enter: 'zoom', text: '$8K, gone|in a year.', highlights: ['$8k'], size: 96, media: {src: 'car/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 137, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 597, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 660, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 896, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 964, src: 'media/sfx_impact.mp3', vol: 0.62},
  {at: 1500, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1692, src: 'media/sfx_impact.mp3', vol: 0.5},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The depreciation curve</span>
      </div>
...
// ---------------------------------------------------------------------------
export const DepreciationReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('car/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('car/music.mp3')}
