...
// ---------------------------------------------------------------------------
// "Built, not inherited" reel — most millionaires aren't trust-fund heirs;
// around eight in ten are first-generation, built on ordinary jobs and a high
// savings rate held for decades. The asset is the gap between earning and
// spending, invested over time. Durations placed on exact spoken-word timestamps
// (ElevenLabs alignment) at +6% pace. Total 1227 frames = ~41s. Mixes video
// clips with stills. The red `impact` card ("the habit is the asset") sits near
// the end; the reel closes on a self-made portrait ("around eight in ten"), not
// the red card. Every scene uses a distinct background sourced fresh for this
// reel — no footage shared with any other reel (see the skill's hard rule).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 63, kind: 'hook', text: 'Picture the person|with a million.', kicker: 'Built, not inherited', highlights: ['million'], size: 80, media: {src: 'millionaire/clip_mansion.mp4', type: 'video', effect: 'in'}},
  {dur: 96, kind: 'text', text: 'Trust fund.|Familiar name.|A head start.', highlights: ['start'], size: 76, media: {src: 'millionaire/p_6700127.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'That picture|is wrong.', highlights: ['wrong'], size: 100},
  {dur: 43, kind: 'stat', stat: {pre: 'First-generation', value: 80, suffix: '%'}, media: {src: 'millionaire/p_3846638.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'First|generation.', highlights: ['first'], size: 96, media: {src: 'millionaire/p_8278872.jpg', type: 'img', effect: 'in'}},
  {dur: 27, kind: 'text', text: 'They built it.', highlights: ['built'], size: 100, media: {src: 'millionaire/p_5785100.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', enter: 'slideL', text: 'They didn\'t|inherit it.', highlights: ['inherit'], size: 88, media: {src: 'millionaire/p_36712864.jpg', type: 'img', effect: 'in'}},
  {dur: 59, kind: 'text', text: 'Most didn\'t earn|large salaries.', highlights: ['large'], size: 78, media: {src: 'millionaire/p_8276182.jpg', type: 'img', effect: 'in'}},
  {dur: 41, kind: 'text', text: 'They saved.|They invested.', highlights: ['saved'], size: 88, media: {src: 'millionaire/clip_coins.mp4', type: 'video', effect: 'in'}},
  {dur: 97, kind: 'text', text: 'On ordinary|jobs.', highlights: ['ordinary'], size: 92, media: {src: 'millionaire/clip_worker.mp4', type: 'video', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'The top jobs|skew unglamorous.', highlights: ['unglamorous'], size: 76, media: {src: 'millionaire/p_8499635.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'lines', text: 'Engineers.|Teachers.|Accountants.', highlights: ['accountants'], reveal: [6, 30, 54], media: {src: 'millionaire/p_4872063.jpg', type: 'img', effect: 'panL'}},
  {dur: 92, kind: 'text', enter: 'slideR', text: 'Paired with a high|savings rate…|held for decades.', highlights: ['savings'], size: 72, media: {src: 'millionaire/p_3848193.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'It isn\'t the size|of the paycheck.', highlights: ['paycheck'], size: 76, media: {src: 'millionaire/p_164686.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'It\'s the gap|between earning|and spending.', highlights: ['gap'], size: 74, media: {src: 'millionaire/p_7735778.jpg', type: 'img', effect: 'in'}},
  {dur: 71, kind: 'text', enter: 'zoom', text: 'Invested|over time.', highlights: ['invested'], size: 88, media: {src: 'millionaire/clip_growth.mp4', type: 'video', effect: 'in'}},
  {dur: 58, kind: 'text', text: 'A modest income|with a wide gap…', highlights: ['wide'], size: 76, media: {src: 'millionaire/p_18280833.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', text: '…outruns a big income|fully spent.', highlights: ['spent'], size: 74, media: {src: 'millionaire/p_37651183.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'A rate.|Not a salary.', highlights: ['rate'], size: 96},
  {dur: 42, kind: 'impact', text: 'The habit|is the asset.', redBg: true},
  {dur: 36, kind: 'text', text: 'Built,|not inherited.', highlights: ['built'], size: 90, media: {src: 'millionaire/p_8344740.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', enter: 'zoom', text: 'Around eight|in ten.', highlights: ['eight'], size: 90, media: {src: 'millionaire/p_7289738.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 159, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 206, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 280, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 367, src: 'media/sfx_chaching.mp3', vol: 0.45},
  {at: 607, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1056, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1101, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1179, src: 'media/sfx_impact.mp3', vol: 0.55},
];
...
const SceneOutro: React.FC = () => {
  ...
  const {fps} = useVideoConfig();
  const parts = [
    {t: 'Not the salary.', red: false},
    {t: 'The gap.', red: false},
    {t: 'Held for decades.', red: true},
  ];
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center'}}>
        ...
        {parts.map((p, i) => {
          ...
          return (
            <span key={i} style={{fontFamily: HEAD, fontSize: p.red ? 138 : 116, textTransform: 'uppercase', letterSpacing: 1, color: C.ink, opacity: s, transform: `translateY(${interpolate(s, [0, 1], [34, 0])}px)`}}>
              {p.red ? (<>Held for <span style={{color: C.red, textShadow: SH}}>decades.</span></>) : p.t}
            </span>
          );
        })}
      </div>
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Built, not inherited</span>
      </div>
...
// ---------------------------------------------------------------------------
export const MillionaireReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('millionaire/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('millionaire/music.mp3')}
