...
// ---------------------------------------------------------------------------
// "The goalpost moved" reel — home affordability is set by the price-to-income
// MULTIPLE, not the sticker. Around 1980 a typical US home cost ~3× household
// income; today it's closer to ~5× (median home ~$410K against a median income
// ~$84K). The house didn't change — the multiple did — and higher mortgage
// rates on a bigger multiple compound the squeeze, so the same job buys less
// house regardless of the sticker. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1594 frames = ~53s.
// Mixes video clips (suburban aerial, counting cash, house framing, keys
// handover) with stills. The red `impact` card ("the goalpost moved") sits
// late; the reel resolves on quieter beats and closes on a lit home at dusk
// ("five times now"), not the red card. Every background is sourced fresh for
// this reel — no footage shared with any other reel (see the skill's hard rule).
//
// NOTE (unverified): the figures — ~3× income c.1980, ~5× today, ~$410K median
// home, ~$84K median income — are rendered as written in the client script and
// have NOT been independently verified; sanity-check against current data (they
// move over time) before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 103, kind: 'hook', text: 'Around 1980,|a typical home.', kicker: 'The goalpost moved', highlights: ['1980'], size: 78, media: {src: 'ratio/p_5587941.jpg', type: 'img', effect: 'in'}},
  {dur: 71, kind: 'text', text: 'Cost three times|income.', highlights: ['three'], size: 84, media: {src: 'ratio/p_164558.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'The house|didn\'t change.', highlights: ['house'], size: 88},
  {dur: 53, kind: 'text', text: 'The multiple|did.', highlights: ['multiple'], size: 100},
  {dur: 90, kind: 'text', text: 'Today, closer to|five times.', highlights: ['five'], size: 80, media: {src: 'ratio/clip_aerial.mp4', type: 'video', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'It isn\'t the|price tag.', highlights: ['price'], size: 82, media: {src: 'ratio/p_32519068.jpg', type: 'img', effect: 'in'}},
  {dur: 80, kind: 'text', enter: 'slideL', text: 'It\'s price relative|to income.', highlights: ['income'], size: 76, media: {src: 'ratio/p_4430243.jpg', type: 'img', effect: 'in'}},
  {dur: 106, kind: 'stat', stat: {pre: 'Median home', prefix: '$', value: 410, suffix: 'K'}, media: {src: 'ratio/p_5353883.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'Against $84K|income.', highlights: ['$84k'], size: 80, media: {src: 'ratio/p_4691477.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', text: 'Nearly five|times.', highlights: ['five'], size: 88, media: {src: 'ratio/p_7947709.jpg', type: 'img', effect: 'in'}},
  {dur: 76, kind: 'text', text: 'A gap a generation|didn\'t face.', highlights: ['generation'], size: 74, media: {src: 'ratio/p_6963889.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'stat', stat: {pre: 'Around 1980', value: 3, suffix: '×'}, media: {src: 'ratio/p_36086367.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'stat', stat: {pre: 'Today', value: 5, suffix: '×'}, media: {src: 'ratio/p_5071130.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'text', enter: 'slideR', text: 'Not just pricier|in dollars.', highlights: ['dollars'], size: 78, media: {src: 'ratio/clip_money.mp4', type: 'video', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'Pricier vs. what|people earn.', highlights: ['earn'], size: 76, media: {src: 'ratio/p_15240212.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'That decides|affordability.', highlights: ['affordability'], size: 78},
  {dur: 59, kind: 'text', text: 'Higher mortgage|rates, too.', highlights: ['mortgage'], size: 76, media: {src: 'ratio/p_8292895.jpg', type: 'img', effect: 'in'}},
  {dur: 85, kind: 'text', text: 'They compound|the squeeze.', highlights: ['squeeze'], size: 80, media: {src: 'ratio/clip_construction.mp4', type: 'video', effect: 'in'}},
  {dur: 87, kind: 'text', text: '"Prices are high"|misses the point.', highlights: ['point'], size: 74, media: {src: 'ratio/p_7578855.jpg', type: 'img', effect: 'in'}},
  {dur: 80, kind: 'text', text: 'The same job|buys less house.', highlights: ['less'], size: 78, media: {src: 'ratio/p_12955837.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'impact', text: 'The goalpost|moved.', redBg: true},
  {dur: 84, kind: 'text', text: 'Harder than it was|for your parents.', highlights: ['harder'], size: 74, media: {src: 'ratio/clip_keys.mp4', type: 'video', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'The math|genuinely shifted.', highlights: ['shifted'], size: 82},
  {dur: 41, kind: 'text', enter: 'zoom', text: 'Three times, then.|Five times now.', highlights: ['five'], size: 78, media: {src: 'ratio/p_1396132.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 266, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 483, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 672, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 797, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 842, src: 'media/sfx_chaching.mp3', vol: 0.42},
  {at: 1196, src: 'media/sfx_whoosh.mp3', vol: 0.38},
  {at: 1363, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1553, src: 'media/sfx_impact.mp3', vol: 0.5},
];
...
const SceneOutro: React.FC = () => {
  ...
  const {fps} = useVideoConfig();
  const parts = [
    {t: 'Three times, then.', red: false},
    {t: 'Five times now.', red: false},
    {t: 'The ratio.', red: true},
  ];
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center'}}>
        ...
        {parts.map((p, i) => {
          ...
          return (
            <span key={i} style={{fontFamily: HEAD, fontSize: p.red ? 138 : 116, textTransform: 'uppercase', letterSpacing: 1, color: C.ink, opacity: s, transform: `translateY(${interpolate(s, [0, 1], [34, 0])}px)`}}>
              {p.red ? (<>The <span style={{color: C.red, textShadow: SH}}>ratio.</span></>) : p.t}
            </span>
          );
        })}
      </div>
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The goalpost moved</span>
      </div>
...
// ---------------------------------------------------------------------------
export const RatioReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('ratio/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('ratio/music.mp3')}
