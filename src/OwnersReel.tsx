...
// ---------------------------------------------------------------------------
// "Markets reward owners, not earners" reel — who actually owns the stock market.
// The market gets called everyone's market, but when it booms almost none of the
// gain reaches most households, because of who owns it: the wealthiest ~10% of US
// households own roughly 90% of all stocks, while the bottom half own about 1%. So
// when the market rises 20%, almost all of that gain flows to the people already
// holding nearly all the shares — a booming market and a struggling household can
// share the same country and year. The divide isn't mainly income, it's
// ownership: wages get taxed and spent while assets compound on their own, and at
// the very top ~1% of households now hold a record ~31% of all US wealth. The
// households pulling away aren't necessarily out-earning everyone — they own
// things that grow while they sleep. Markets reward owners, not earners; most
// people watch the gains from the wrong side of that line. The voiceover runs
// continuously with no dead air and scene durations sit on its exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace — total 1655 frames = ~55s.
// Full-bleed footage on nearly every beat, with one black beat (the 90%-vs-1%
// closing comparison) and one red "reward owners, not earners" impact card. Every
// background is sourced fresh for this reel (hard rule).
//
// NOTE (real figures — verify before publishing): the "top 10% own ~90% of
// stocks", "bottom 50% own ~1%", and "top 1% hold a record ~31% of US wealth"
// stats echo the Federal Reserve Distributional Financial Accounts and are widely
// reported, but the exact shares move each quarter; the "market rises 20%" is an
// illustrative round number. Confirm the current DFA figures before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 146, kind: 'hook', text: 'Called everyone\'s|market.', kicker: 'Markets reward owners', highlights: ['everyone\'s'], size: 84, media: {src: 'owners/p_floor.jpg', type: 'img', effect: 'in'}},
  {dur: 65, kind: 'text', text: 'The boom skips|most households.', highlights: ['skips'], size: 80, media: {src: 'owners/p_home.jpg', type: 'img', effect: 'in'}},
  {dur: 131, kind: 'text', enter: 'zoom', text: 'It\'s about who|owns it.', highlights: ['owns'], size: 88, media: {src: 'owners/p_owns.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'stat', stat: {pre: 'The top 10% own', value: 90, suffix: '%', post: 'of all stocks'}, media: {src: 'owners/p_rich90.jpg', type: 'img', effect: 'in'}},
  {dur: 59, kind: 'stat', stat: {pre: 'The bottom half own', value: 1, suffix: '%'}, media: {src: 'owners/p_wallet.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'stat', stat: {pre: 'When the market rises', value: 20, suffix: '%'}, media: {src: 'owners/p_up20.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', text: 'Almost all of it|flows to the top.', highlights: ['top'], size: 80, media: {src: 'owners/p_flowtop.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'They already|hold the shares.', highlights: ['shares'], size: 82, media: {src: 'owners/p_shares.jpg', type: 'img', effect: 'in'}},
  {dur: 108, kind: 'text', enter: 'slideL', text: 'A boom and a|struggle. One year.', highlights: ['struggle'], size: 74, media: {src: 'owners/p_boom.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Same country,|same year.', highlights: ['same'], size: 82, media: {src: 'owners/p_struggle.jpg', type: 'img', effect: 'in'}},
  {dur: 36, kind: 'text', text: 'The divide isn\'t|income.', highlights: ['income'], size: 84, media: {src: 'owners/p_income.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'It\'s|ownership.', highlights: ['ownership'], size: 108, media: {src: 'owners/p_ownership.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'Wages get taxed|and spent.', highlights: ['taxed'], size: 82, media: {src: 'owners/p_tax.jpg', type: 'img', effect: 'in'}},
  {dur: 121, kind: 'text', enter: 'slideR', text: 'Assets compound|on their own.', highlights: ['compound'], size: 80, media: {src: 'owners/p_compound.jpg', type: 'img', effect: 'in'}},
  {dur: 93, kind: 'stat', stat: {pre: 'The top 1% now hold', value: 31, suffix: '%', post: 'of US wealth — a record'}, media: {src: 'owners/p_rich31.jpg', type: 'img', effect: 'in'}},
  {dur: 52, kind: 'text', text: 'The gap is|pulling away.', highlights: ['pulling'], size: 82, media: {src: 'owners/p_pullaway.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Not always|out-earning you.', highlights: ['out-earning'], size: 80, media: {src: 'owners/p_earn.jpg', type: 'img', effect: 'in'}},
  {dur: 74, kind: 'text', enter: 'zoom', text: 'They grow it|while they sleep.', highlights: ['sleep'], size: 80, media: {src: 'owners/p_sleep.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'Drawn by ownership,|not salary.', highlights: ['salary'], size: 78, media: {src: 'owners/p_assets.jpg', type: 'img', effect: 'in'}},
  {dur: 95, kind: 'impact', text: 'Markets reward owners,|not earners.', redBg: true},
  {dur: 66, kind: 'text', text: 'Most watch from|the wrong side.', highlights: ['wrong'], size: 80, media: {src: 'owners/p_window.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'compare', compare: {a: {value: 10, suffix: '%', label: 'own ninety percent'}, b: {value: 50, suffix: '%', label: 'own just one'}, note: 'Owners, not earners'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 211, src: 'media/sfx_whoosh.mp3', vol: 0.32}, // cut into "who owns it"
  {at: 342, src: 'media/sfx_impact.mp3', vol: 0.5}, // 90% of stocks
  {at: 425, src: 'media/sfx_impact.mp3', vol: 0.45}, // 1%
  {at: 484, src: 'media/sfx_impact.mp3', vol: 0.5}, // market rises 20%
  {at: 1086, src: 'media/sfx_impact.mp3', vol: 0.55}, // 31% — a record
  {at: 1421, src: 'media/sfx_impact.mp3', vol: 0.62}, // red card — owners not earners
  {at: 1582, src: 'media/sfx_impact.mp3', vol: 0.5}, // closing compare
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Markets reward owners</span>
      </div>
...
// ---------------------------------------------------------------------------
export const OwnersReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('owners/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('owners/music.mp3')}
