...
// ---------------------------------------------------------------------------
// "Money isn't demand" reel — Quibi. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1447 frames = ~48.2s.
// `enter` adds a transition on some cuts. Every scene uses a distinct
// background sourced fresh for this reel — no footage is shared with any
// other reel (see the skill's hard rule).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 87, kind: 'hook', text: 'It raised|$1.75 billion.', kicker: 'Money isn’t demand', highlights: ['billion'], size: 92, media: {src: 'quibi/p_14820469.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'text', enter: 'slideL', text: 'Hired the biggest|studios in Hollywood.|Then launched.', highlights: ['Hollywood'], size: 72, media: {src: 'quibi/p_8088386.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'And was dead|in six months.', highlights: ['dead'], size: 88, media: {src: 'quibi/p_7234225.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'text', text: 'The money was|never the problem.', highlights: ['never'], size: 88},
  {dur: 60, kind: 'text', text: 'Quibi launched|in April 2020.', highlights: ['Quibi'], size: 84, media: {src: 'quibi/p_6611922.jpg', type: 'img', effect: 'in'}},
  {dur: 93, kind: 'lines', text: 'Celebrity backers.|Big-name content.|Premium video.', highlights: ['premium'], reveal: [0, 26, 52], media: {src: 'quibi/clip_spotlight.mp4', type: 'video', effect: 'in'}},
  {dur: 77, kind: 'text', enter: 'slideR', text: 'Short, mobile-first|bites of video.', highlights: ['mobile-first'], size: 78, media: {src: 'quibi/p_5875077.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'The bet had|unusual credibility.', highlights: ['credibility'], size: 82},
  {dur: 76, kind: 'text', text: 'Founders who had built|and sold|major companies.', highlights: ['founders'], size: 74, media: {src: 'quibi/p_5466788.jpg', type: 'img', effect: 'panR'}},
  {dur: 67, kind: 'text', text: 'The biggest studios|supplied the content.', highlights: ['studios'], size: 78, media: {src: 'quibi/p_8089248.jpg', type: 'img', effect: 'in'}},
  {dur: 103, kind: 'text', enter: 'slideL', text: 'The money came before|anyone was asked|if they wanted it.', highlights: ['before'], size: 72, media: {src: 'quibi/p_14820420.jpg', type: 'img', effect: 'in'}},
  {dur: 112, kind: 'text', text: 'Capital couldn’t buy|evidence that|anyone did.', highlights: ['evidence'], size: 74},
  {dur: 62, kind: 'text', text: 'Users|didn’t show up.', highlights: ['users'], size: 96, media: {src: 'quibi/p_8159242.jpg', type: 'img', effect: 'in'}},
  {dur: 79, kind: 'text', enter: 'zoom', text: 'It misread how people|watch on their phones.', highlights: ['misread'], size: 76, media: {src: 'quibi/clip_scroll.mp4', type: 'video', effect: 'in'}},
  {dur: 132, kind: 'text', text: 'It shut down.|December 2020.|Six months in.', highlights: ['shut', 'down'], size: 74, media: {src: 'quibi/p_16723181.jpg', type: 'img', effect: 'in'}},
  {dur: 153, kind: 'stat', stat: {pre: 'Unvalidated demand cost', prefix: '$', value: 1.75, decimals: 2, suffix: 'B'}},
  {dur: 108, kind: 'impact', text: 'You can’t buy|a want that isn’t there.', redBg: true},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 87, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 170, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 325, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 698, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 913, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 975, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1054, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 1186, src: 'media/sfx_impact.mp3', vol: 0.6},
  {at: 1339, src: 'media/sfx_impact.mp3', vol: 0.72},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Money isn’t demand</span>
      </div>
...
// ---------------------------------------------------------------------------
export const QuibiReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('quibi/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('quibi/music.mp3')}
