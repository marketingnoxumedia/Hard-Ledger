...
// ---------------------------------------------------------------------------
// "The cost of waiting" reel (WaitReel) — compounding and starting early, told as the A/B twin of
// the existing HeadstartReel ("The ten-year head start"), which opens flat and closes on the two
// figures. Two people save the same $500/mo at an assumed 7% return; the only difference is a
// ten-year head start. Begin at 25 and stop at 65 — about $240K of your own money grows, as an
// illustration, to roughly $1.3M. Begin at 35 instead: you pay in about $60K less and end near
// $610K — a ten-year delay roughly halves the result on barely less money in. Compounding pays
// growth on past growth, so the earliest dollars matter most: the first decade is closer to half
// the outcome than a quarter. Time did more of the work than the money — the gap was years, not
// effort. Question hook ("...why a ten-year head start can be worth more than the money itself?")
// and a rhetorical question close ("what is waiting to start actually costing?"); a ~1.5s post-hook
// pause (the hook holds through the silence before the reveal — house convention); two count-up
// `stat` beats ($1.3M / $610K), one red "It's closer to half." `impact` card as the mid-tail
// thesis, and the question close on footage rather than the red card. Durations sit on exact
// ElevenLabs spoken-word timestamps at +6% pace; music normalized and mixed at 0.17. Total 1428
// frames = ~47.6s. Entirely its own fresh footage under public/wait/ — no asset shared with
// HeadstartReel or any other reel. **FLAG — illustrative figures:** the $500/mo, 7% return,
// ~$1.3M / ~$610K, and ~$240K/$60K-in numbers are a compounding illustration (returns are not
// guaranteed and ignore inflation, taxes, and fees) — present them as an example, not a promise.
// Imagery is generic — no bank/brokerage/fund brands, tickers, or legible company marks.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 92, kind: 'hook', text: 'Why a ten-year|head start—', kicker: 'The cost of waiting', highlights: ['head'], size: 82, media: {src: 'wait/v_hook.mp4', type: 'video', effect: 'in'}},
  // Short ~1.5s pause after the hook (house convention): 45 frames of silence are spliced into
  // the VO right after "...worth more than the money itself?", and this beat holds through it (25 -> 70).
  {dur: 70, kind: 'text', text: 'worth more than|the money itself?', highlights: ['money'], size: 82},
  {dur: 90, kind: 'text', text: 'Two people save|the same $500.', highlights: ['$500'], size: 84, media: {src: 'wait/p_jar.jpg', type: 'img', effect: 'in'}},
  {dur: 79, kind: 'text', enter: 'slideL', text: 'One ends with|double the other.', highlights: ['double'], size: 84, media: {src: 'wait/v_growth.mp4', type: 'video', effect: 'in'}},
  {dur: 56, kind: 'text', text: '$500 a month.|Seven percent.', highlights: ['seven'], size: 88, media: {src: 'wait/p_cash.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'Only the start|date changes.', highlights: ['start'], size: 86},
  {dur: 72, kind: 'text', enter: 'slideL', text: 'Begin|at 25.', highlights: ['25'], size: 100, media: {src: 'wait/p_young.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'text', text: '$240K of your|own money—', highlights: ['$240k'], size: 84, media: {src: 'wait/v_young.mp4', type: 'video', effect: 'in'}},
  {dur: 59, kind: 'stat', stat: {pre: 'BY AGE 65, GROWS TO', prefix: '$', value: 1.3, decimals: 1, suffix: 'M'}},
  {dur: 53, kind: 'text', text: 'Now begin|at 35.', highlights: ['35'], size: 100, media: {src: 'wait/p_older.jpg', type: 'img', effect: 'in'}},
  {dur: 58, kind: 'text', text: 'You pay in|$60K less—', highlights: ['$60k'], size: 88},
  {dur: 87, kind: 'stat', stat: {pre: 'AND YOU END NEAR', prefix: '$', value: 610, suffix: 'K'}},
  {dur: 111, kind: 'text', enter: 'slideL', text: 'A ten-year delay|halves it.', highlights: ['halves'], size: 84, media: {src: 'wait/v_clock.mp4', type: 'video', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'Compounding pays|on past gains.', highlights: ['compounding'], size: 82},
  {dur: 100, kind: 'text', text: 'The earliest dollars|matter most.', highlights: ['earliest'], size: 84, media: {src: 'wait/p_hourglass.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'Not a quarter|of the outcome.', highlights: ['quarter'], size: 84},
  {dur: 47, kind: 'impact', text: "It's closer|to half.", redBg: true},
  {dur: 53, kind: 'text', text: 'Time did more work|than the money.', highlights: ['time'], size: 84, media: {src: 'wait/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 25, kind: 'text', text: "The gap wasn't|effort.", highlights: ['effort'], size: 92},
  {dur: 33, kind: 'text', text: 'It was|years.', highlights: ['years'], size: 100},
  {dur: 71, kind: 'text', text: 'If a decade beats|the dollars—', highlights: ['decade'], size: 84},
  {dur: 69, kind: 'text', enter: 'zoom', text: "what's waiting|actually costing?", highlights: ['waiting'], size: 84, media: {src: 'wait/v_close.mp4', type: 'video', effect: 'in'}},
];
...
const SFX: SfxCue[] = [
  {at: 162, src: 'media/sfx_whoosh.mp3', vol: 0.4},    // reveal after the pause
  {at: 585, src: 'media/sfx_chaching.mp3', vol: 0.5},  // $1.3M reveal
  {at: 755, src: 'media/sfx_impact.mp3', vol: 0.55},   // $610K reveal
  {at: 1130, src: 'media/sfx_impact.mp3', vol: 0.72},  // red "It's closer to half." card
  {at: 1359, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // question close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The cost of waiting</span>
      </div>
...
// ---------------------------------------------------------------------------
export const WaitReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('wait/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('wait/music.mp3')}
