...
// ---------------------------------------------------------------------------
// "It depends" reel — the rent-vs-buy myth. There's a slogan that renting is
// throwing money away and buying is always the smart move; sometimes buying is the
// more expensive mistake. The belief is easy to hold — rent leaves nothing to
// point to, while a mortgage feels like forced saving. But buying carries costs the
// slogan ignores (interest, property taxes, maintenance, insurance, transaction
// fees), and the down payment has an opportunity cost: that money could have been
// invested. Whether buying wins depends on how long you stay, local price-to-rent
// ratios, and what the cash would otherwise earn. Owners build equity but tie up
// capital; renters keep flexibility and can invest the difference. The same house
// can favour buying in one city and renting in another. The honest answer is a
// calculation, not a maxim — change the inputs and it often flips within a few
// years of break-even. Renting isn't always waste; buying isn't always smart; it
// depends. The voiceover runs continuously with no dead air and scene durations sit
// on its exact spoken-word timestamps (ElevenLabs alignment) at +6% pace — total
// 1721 frames = ~57s. Full-bleed footage on nearly every beat, with one black beat
// (the hidden-cost list) and one red "a calculation, not a slogan" impact card,
// closing on footage. Every background is sourced fresh for this reel (hard rule).
//
// NOTE (illustration, not advice): a conceptual explainer with no asserted prices
// or figures. Whether renting or buying wins genuinely depends on time horizon,
// local price-to-rent ratios, mortgage rate, and the opportunity cost of the down
// payment — directional, not a recommendation for any specific market.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 102, kind: 'hook', text: 'Renting throws|money away.', kicker: 'Rent vs. buy — it depends', highlights: ['away'], size: 84, media: {src: 'rent/p_rentsign.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'text', text: 'Buying is|always smart.', highlights: ['smart'], size: 84, media: {src: 'rent/p_soldsign.jpg', type: 'img', effect: 'in'}},
  {dur: 86, kind: 'text', text: 'Sometimes buying|costs more.', highlights: ['more'], size: 82, media: {src: 'rent/p_mistake.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', enter: 'zoom', text: 'The belief is|easy to hold.', highlights: ['easy'], size: 82, media: {src: 'rent/p_belief.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', text: 'Rent leaves|nothing behind.', highlights: ['nothing'], size: 82, media: {src: 'rent/p_nothing.jpg', type: 'img', effect: 'in'}},
  {dur: 94, kind: 'text', text: 'A mortgage feels|like saving.', highlights: ['saving'], size: 82, media: {src: 'rent/p_saving.jpg', type: 'img', effect: 'in'}},
  {dur: 50, kind: 'text', text: 'But buying has|hidden costs.', highlights: ['hidden'], size: 82, media: {src: 'rent/p_hidden.jpg', type: 'img', effect: 'in'}},
  {dur: 162, kind: 'lines', text: 'Interest|Property taxes|Maintenance|Insurance|Fees', highlights: ['fees'], reveal: [10, 34, 58, 82, 106]},
  {dur: 48, kind: 'text', text: 'The down payment|has a cost.', highlights: ['cost'], size: 82, media: {src: 'rent/p_downpay.jpg', type: 'img', effect: 'in'}},
  {dur: 76, kind: 'text', enter: 'slideL', text: 'That cash could|be invested.', highlights: ['invested'], size: 82, media: {src: 'rent/p_invested.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'How long|you stay.', highlights: ['long'], size: 88, media: {src: 'rent/p_stay.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'text', text: 'Local|price-to-rent.', highlights: ['price-to-rent'], size: 84, media: {src: 'rent/p_ratio.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'What the cash|would earn.', highlights: ['earn'], size: 82, media: {src: 'rent/p_earn.jpg', type: 'img', effect: 'in'}},
  {dur: 101, kind: 'text', enter: 'slideR', text: 'Owners build|equity.', highlights: ['equity'], size: 90, media: {src: 'rent/p_equity.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'Renters keep|flexibility.', highlights: ['flexibility'], size: 84, media: {src: 'rent/p_flex.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'And invest|the difference.', highlights: ['difference'], size: 82, media: {src: 'rent/p_diff.jpg', type: 'img', effect: 'in'}},
  {dur: 105, kind: 'text', text: 'Neither is|automatically right.', highlights: ['neither'], size: 80, media: {src: 'rent/p_scale.jpg', type: 'img', effect: 'in'}},
  {dur: 89, kind: 'text', enter: 'zoom', text: 'Buy in one city,|rent in another.', highlights: ['another'], size: 76, media: {src: 'rent/p_city.jpg', type: 'img', effect: 'in'}},
  {dur: 88, kind: 'text', text: 'It\'s a calculation,|not a maxim.', highlights: ['calculation'], size: 78, media: {src: 'rent/p_calc.jpg', type: 'img', effect: 'in'}},
  {dur: 96, kind: 'text', text: 'The answer flips|at break-even.', highlights: ['flips'], size: 80, media: {src: 'rent/p_flip.jpg', type: 'img', effect: 'in'}},
  {dur: 113, kind: 'impact', text: 'A calculation,|not a slogan.', redBg: true},
  {dur: 66, kind: 'text', enter: 'slideL', text: 'Renting isn\'t|always waste.', highlights: ['waste'], size: 82, media: {src: 'rent/p_waste.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'It|depends.', highlights: ['depends'], size: 104, media: {src: 'rent/p_depends.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 251, src: 'media/sfx_whoosh.mp3', vol: 0.3}, // cut into "easy to hold"
  {at: 512, src: 'media/sfx_impact.mp3', vol: 0.5}, // hidden-cost list
  {at: 945, src: 'media/sfx_whoosh.mp3', vol: 0.3}, // cut into "owners build equity"
  {at: 1235, src: 'media/sfx_whoosh.mp3', vol: 0.3}, // cut into "one city, another"
  {at: 1508, src: 'media/sfx_impact.mp3', vol: 0.62}, // red card — a calculation, not a slogan
  {at: 1687, src: 'media/sfx_impact.mp3', vol: 0.5}, // close — it depends
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Rent vs. buy</span>
      </div>
...
// ---------------------------------------------------------------------------
export const RentReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('rent/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('rent/music.mp3')}
