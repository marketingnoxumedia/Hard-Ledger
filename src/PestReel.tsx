...
// ---------------------------------------------------------------------------
// "It kills bugs" reel — Rollins / Orkin recurring pest-control revenue.
// Durations placed on exact spoken-word timestamps (ElevenLabs alignment) at
// +6% pace. Total 1278 frames = ~42.6s. `enter` adds a transition on some cuts.
...
const SCENES: SceneDef[] = [
  {dur: 128, kind: 'hook', text: 'It grew revenue|every year for|24 years.', kicker: 'It kills bugs', highlights: ['24'], size: 76, media: {src: 'pest/p_19789841.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: 'It doesn’t|sell software.', highlights: ['software'], size: 86, media: {src: 'pest/p_546819.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'It kills|bugs.', highlights: ['bugs'], size: 108, media: {src: 'pest/p_19294665.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', enter: 'slideL', text: 'Rollins —|parent of Orkin.', highlights: ['Orkin'], size: 84, media: {src: 'pest/p_32055757.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', text: 'Technicians on|recurring schedules.', highlights: ['recurring'], size: 80, media: {src: 'pest/p_4176548.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', text: 'Treating homes|and businesses|for pests.', highlights: ['pests'], size: 76, media: {src: 'pest/p_19789837.jpg', type: 'img', effect: 'panR'}},
  {dur: 90, kind: 'text', enter: 'slideR', text: 'Recurrence guaranteed|by biology —|not by contract.', highlights: ['biology'], size: 74, media: {src: 'pest/p_17177368.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'Pests|come back.', highlights: ['back'], size: 100, media: {src: 'pest/p_11032990.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'The treatment is|never finished.', highlights: ['never'], size: 84, media: {src: 'pest/p_36302077.jpg', type: 'img', effect: 'in'}},
  {dur: 77, kind: 'text', text: 'The visit is small|on a household budget.', highlights: ['small'], size: 76, media: {src: 'pest/p_14647295.jpg', type: 'img', effect: 'in'}},
  {dur: 90, kind: 'text', text: 'So cancelling never|tops anyone’s list.', highlights: ['cancelling'], size: 76},
  {dur: 45, kind: 'text', enter: 'zoom', text: 'Route density|does the rest.', highlights: ['route'], size: 84, media: {src: 'pest/p_30954662.jpg', type: 'img', effect: 'in'}},
  {dur: 114, kind: 'text', enter: 'slideL', text: 'Spreading drive time|across many|nearby stops.', highlights: ['stops'], size: 74, media: {src: 'pest/p_8148350.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', text: 'A route-based network.|Millions of|recurring accounts.', highlights: ['millions'], size: 74, media: {src: 'pest/p_28490242.jpg', type: 'img', effect: 'panL'}},
...
const SFX: SfxCue[] = [
  {at: 174, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 207, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 404, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 494, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 740, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1001, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1079, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1138, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1194, src: 'media/sfx_impact.mp3', vol: 0.72},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>It kills bugs</span>
      </div>
...
// ---------------------------------------------------------------------------
export const PestReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('pest/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('pest/music.mp3')}
