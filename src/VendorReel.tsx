...
// ---------------------------------------------------------------------------
// "The vendor trap" reel (VendorReel) — Borders outsourcing its online store to Amazon, told as the
// A/B twin of the existing BordersReel ("The outsourced channel"), which opens and closes
// declaratively. Here the hook and close are rhetorical questions. A bookstore giant didn't just lose
// to a better rival — in the early 2000s Borders had no digital arm of its own and handed its entire
// online store to Amazon. Outsourcing looked like prudence, not surrender: e-commerce was lossmaking,
// Amazon's platform already worked, and the deal gave Borders an online presence for nothing. But
// what it quietly handed over was the customer and the purchase data — the two assets that would
// decide the next decade — so Borders never built its own online muscle, customers or data, and when
// shopping moved online for good it had nothing to stand on. It handed its digital future to a rival
// in 2001 and filed for bankruptcy in 2011. Don't outsource the future: give a rival the channel
// about to matter most and you hand over your customers and everything you'd have learned. Question
// hook ("...why did Borders hand its entire online store to Amazon, years before it collapsed?") and
// a rhetorical question close ("who's really building the business — them, or the vendor?"); a ~1.2s
// post-hook pause (the hook holds through the silence before the reveal — house convention); the
// punch is the 2001 -> 2011 year contrast in big type, one red "The two assets that decide it all."
// `impact` card as the mid-tail thesis, and the question close on footage. **Media-dense:** 21 of 24
// beats carry footage, with only 2 flat-black beats ("Borders built none of it.", "Nothing left to
// stand on.") plus the one red card. Durations on exact ElevenLabs spoken-word timestamps at +6%
// pace; music normalized and mixed at 0.17. Total 1760 frames = ~58.7s. Entirely its own fresh
// footage under public/vendor/ — no asset shared with BordersReel or any other reel. **Brand-safety:**
// the reel names Borders and Amazon in voiceover only — all footage must be generic, with NO Borders
// or Amazon logos/boxes/signage and no other readable brand marks. Confirm no stray brand marks
// before publishing. **Real companies/dates — verify:** the Borders outsourcing-to-Amazon deal (2001)
// and Borders' bankruptcy (2011) are real events rendered as written; double-check the specifics and
// framing before publishing. Same topic as BordersReel — publish only one twin to a given audience,
// and schedule apart.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  ...
  {dur: 75, kind: 'text', enter: 'slideL', text: 'It was|Borders.', highlights: ['borders'], size: 104, media: {src: 'vendor/p_store.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'A book-retail|giant.', highlights: ['giant'], size: 92, media: {src: 'vendor/p_books.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'text', text: 'No digital arm|of its own.', highlights: ['digital'], size: 86, media: {src: 'vendor/p_nodigital.jpg', type: 'img', effect: 'in'}},
  {dur: 82, kind: 'text', enter: 'slideL', text: 'Outsourcing looked|like prudence.', highlights: ['prudence'], size: 82, media: {src: 'vendor/p_boardroom.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'E-commerce was|lossmaking.', highlights: ['lossmaking'], size: 84, media: {src: 'vendor/p_losschart.jpg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', text: "Amazon's platform|already worked.", highlights: ['worked'], size: 84, media: {src: 'vendor/v_online.mp4', type: 'video', effect: 'in'}},
  {dur: 77, kind: 'text', enter: 'slideL', text: 'An online presence|for nothing.', highlights: ['presence'], size: 84, media: {src: 'vendor/p_laptop.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'But it handed over|the customer.', highlights: ['customer'], size: 82, media: {src: 'vendor/p_customer.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'And the|purchase data.', highlights: ['purchase'], size: 88, media: {src: 'vendor/p_data.jpg', type: 'img', effect: 'in'}},
  {dur: 100, kind: 'impact', text: 'The two assets|that decide it all.', redBg: true},
  {dur: 32, kind: 'text', text: 'Borders built|none of it.', highlights: ['none'], size: 90},
  {dur: 82, kind: 'lines', text: 'No muscle.|No customers.|No data.', highlights: ['data'], reveal: [2, 28, 54], media: {src: 'vendor/p_empty.jpg', type: 'img', effect: 'in'}},
  {dur: 106, kind: 'text', text: 'Nothing left|to stand on.', highlights: ['nothing'], size: 92},
  {dur: 116, kind: 'text', enter: 'slideL', text: 'Outsourced:|2001.', highlights: ['2001'], size: 100, media: {src: 'vendor/p_deal.jpg', type: 'img', effect: 'in'}},
  {dur: 119, kind: 'text', text: 'Bankrupt:|2011.', highlights: ['2011'], size: 100, media: {src: 'vendor/p_closed.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: "Don't outsource|the future.", highlights: ['future'], size: 90, media: {src: 'vendor/p_future.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'text', enter: 'slideL', text: 'Give away the|channel.', highlights: ['channel'], size: 88, media: {src: 'vendor/v_warehouse.mp4', type: 'video', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'Hand over|your customers.', highlights: ['customers'], size: 86, media: {src: 'vendor/p_shoppers.jpg', type: 'img', effect: 'in'}},
  {dur: 73, kind: 'text', text: "And all you'd|have learned.", highlights: ['learned'], size: 86, media: {src: 'vendor/p_learn.jpg', type: 'img', effect: 'in'}},
  {dur: 24, kind: 'text', text: 'Outsource the|hard part.', highlights: ['hard'], size: 90, media: {src: 'vendor/p_vendor.jpg', type: 'img', effect: 'in'}},
  {dur: 97, kind: 'text', enter: 'zoom', text: "Who's building it:|them, or the vendor?", highlights: ['vendor?'], size: 78, media: {src: 'vendor/v_close.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
// NOTE: a 36-frame (~1.2s) pause is spliced after the hook question (at frame ~202), so every cue
// below is already on the post-pause timeline.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 280, src: 'media/sfx_whoosh.mp3', vol: 0.4},    // reveal after the pause ("It was Borders")
  {at: 593, src: 'media/sfx_whoosh.mp3', vol: 0.35},  // cut to Amazon's platform
  {at: 843, src: 'media/sfx_impact.mp3', vol: 0.72},  // red 'the two assets' card
  {at: 1163, src: 'media/sfx_impact.mp3', vol: 0.5},  // "Outsourced: 2001"
  {at: 1279, src: 'media/sfx_impact.mp3', vol: 0.6},  // "Bankrupt: 2011"
  {at: 1663, src: 'media/sfx_whoosh.mp3', vol: 0.4},   // question close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The vendor trap</span>
      </div>
...
// ---------------------------------------------------------------------------
export const VendorReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('vendor/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('vendor/music.mp3')}
