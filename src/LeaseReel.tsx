...
// ---------------------------------------------------------------------------
// "One path ends the payment" reel — leasing forever vs buying and holding a car.
// Two people drive the same kind of car for ten years: one ends the decade owning
// nothing and still writing a monthly cheque, the other is paid off and still
// driving. They didn't pick different cars — they picked different ways to hold
// one. Lease continuously and you're always in a new car but carry a permanent
// payment; buy once and keep it and you pay more up front (or finance a few
// years), then the loan ends and the cost trends toward zero. Over a long horizon
// holding is usually the cheaper path, and the longer the car is kept the wider
// the gap — terms, rates and upkeep move the size of it, not the direction. The
// voiceover runs continuously with no dead air and scene durations sit on its
// exact spoken-word timestamps (ElevenLabs alignment) at +6% pace — total 1410
// frames = ~47s. Full-bleed footage on nearly every beat (cars, keys, bills,
// charts, an odometer), with only one black beat ("different ways to hold it") and
// the one red "one path ends the payment" impact card near the end. Every
// background is sourced fresh for this reel (hard rule).
//
// NOTE (illustration, not advice): a conceptual comparison of two ways to pay for
// a car over a long horizon — no specific prices, rates or figures are asserted,
// and the "holding is usually cheaper over a long horizon" claim depends on lease
// terms, interest rates, resale value and upkeep. Directional, not a quote for any
// particular car — confirm the numbers for a real decision before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 115, kind: 'hook', text: 'Two drivers,|one car.', kicker: 'Lease vs. own', highlights: ['one'], size: 92, media: {src: 'lease/p_two.jpg', type: 'img', effect: 'in'}},
  {dur: 76, kind: 'text', text: 'One owns nothing|and still pays.', highlights: ['nothing'], size: 80, media: {src: 'lease/p_bill.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'They chose|the same car.', highlights: ['same'], size: 86, media: {src: 'lease/p_samecar.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'impact', text: 'Different ways|to hold it.'},
  {dur: 115, kind: 'text', enter: 'zoom', text: 'Lease again,|or buy once.', highlights: ['buy'], size: 84, media: {src: 'lease/p_fork.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Same ten years,|same road.', highlights: ['road'], size: 82, media: {src: 'lease/p_road.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'Lease: always|a new car.', highlights: ['new'], size: 84, media: {src: 'lease/p_newcar.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', text: 'A payment that|never stops.', highlights: ['never'], size: 82, media: {src: 'lease/p_payment.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'Buy: more|up front.', highlights: ['front'], size: 88, media: {src: 'lease/p_cash.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Then the|loan ends.', highlights: ['ends'], size: 92, media: {src: 'lease/p_sign.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'text', text: 'Ten years in,|paths diverge.', highlights: ['diverge'], size: 80, media: {src: 'lease/p_diverge.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', enter: 'slideR', text: 'Leaser: still|paying.', highlights: ['paying'], size: 88, media: {src: 'lease/p_dealer.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'Owner: paid|off.', highlights: ['off'], size: 96, media: {src: 'lease/p_driver.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Cost trending|toward zero.', highlights: ['zero'], size: 84, media: {src: 'lease/p_zero.jpg', type: 'img', effect: 'in'}},
  {dur: 28, kind: 'text', text: 'Leasing buys|the newest car.', highlights: ['newest'], size: 78, media: {src: 'lease/p_luxury.jpg', type: 'img', effect: 'in'}},
  {dur: 119, kind: 'text', enter: 'zoom', text: 'And an endless|payment.', highlights: ['endless'], size: 86, media: {src: 'lease/p_calendar.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'text', text: 'Holding is|the cheaper path.', highlights: ['cheaper'], size: 82, media: {src: 'lease/p_piggy.jpg', type: 'img', effect: 'in'}},
  {dur: 99, kind: 'text', enter: 'slideL', text: 'Keep it longer,|the gap widens.', highlights: ['widens'], size: 78, media: {src: 'lease/p_gap.jpg', type: 'img', effect: 'in'}},
  {dur: 31, kind: 'text', text: 'Terms move the size,|not the direction.', highlights: ['direction'], size: 66, media: {src: 'lease/p_upkeep.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'impact', text: 'One path|ends the payment.', redBg: true},
  {dur: 45, kind: 'text', text: 'The other|never does.', highlights: ['never'], size: 96, media: {src: 'lease/p_old.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 292, src: 'media/sfx_whoosh.mp3', vol: 0.32}, // cut into "lease again, or buy once"
  {at: 721, src: 'media/sfx_impact.mp3', vol: 0.5}, // paths diverge
  {at: 863, src: 'media/sfx_impact.mp3', vol: 0.5}, // cost toward zero
  {at: 1004, src: 'media/sfx_whoosh.mp3', vol: 0.3}, // cut into "endless payment"
  {at: 1323, src: 'media/sfx_impact.mp3', vol: 0.62}, // red card — one path ends the payment
  {at: 1365, src: 'media/sfx_impact.mp3', vol: 0.5}, // close
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Lease vs. own</span>
      </div>
...
// ---------------------------------------------------------------------------
export const LeaseReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('lease/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('lease/music.mp3')}
