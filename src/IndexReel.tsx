...
// ---------------------------------------------------------------------------
// "The return was always there" reel — index investing and patience. There's a
// return that's been available for a hundred years, beats most professional
// investors, and asks for no skill — only patience. It's the broad US stock
// market: over the long run it's returned about 10% a year, roughly 7% after
// inflation. At ~10%, money doubles roughly every 7 years — $10K becomes ~$20K,
// then ~$40K, without adding a cent — though the average hides wild years inside
// it. The catch: over 15 years, about 90% of professional large-cap funds fail to
// beat that simple index; the experts, with all their tools, mostly trail it. You
// don't beat the market by being clever, you capture it by staying in — the
// horizon does the heavy lifting and the usual enemy is impatience, not
// stock-picking. The return was always available; the hard part was never the
// strategy, it was sitting still. The voiceover runs continuously with no dead air
// and scene durations sit on its exact spoken-word timestamps (ElevenLabs
// alignment) at +6% pace — total 1535 frames = ~51s. Full-bleed footage on nearly
// every beat (coins, charts, traders, a ticker board), with only one black beat
// (the 10%-vs-90% closing comparison) and the one red "sitting still" impact card
// near the end. Every background is sourced fresh for this reel (hard rule).
//
// NOTE (illustration / unverified): the ~10% long-run nominal / ~7% real US
// equity return, the rule-of-thumb ~7-year doubling, and the "~90% of large-cap
// funds trail the index over 15 years" figure are the commonly-cited, widely-
// reported versions (the last echoes SPIVA-style scorecards). Round rule-of-thumb
// numbers, not a forecast or precise statistic — confirm before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 82, kind: 'hook', text: 'A return, free|for 100 years.', kicker: 'The return was always there', highlights: ['100'], size: 78, media: {src: 'index/p_century.jpg', type: 'img', effect: 'in'}},
  {dur: 105, kind: 'text', text: 'It beats most|professionals.', highlights: ['beats'], size: 80, media: {src: 'index/p_pros.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'It asks only|for patience.', highlights: ['patience'], size: 80, media: {src: 'index/p_patience.jpg', type: 'img', effect: 'in'}},
  {dur: 100, kind: 'text', enter: 'zoom', text: 'The broad|US market.', highlights: ['market'], size: 88, media: {src: 'index/p_market.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'stat', stat: {pre: 'Returned, per year', value: 10, suffix: '%'}, media: {src: 'index/p_10pct.jpg', type: 'img', effect: 'in'}},
  {dur: 109, kind: 'stat', stat: {pre: 'After inflation', value: 7, suffix: '%'}, media: {src: 'index/p_7pct.jpg', type: 'img', effect: 'in'}},
  {dur: 32, kind: 'text', text: 'Money|doubles.', highlights: ['doubles'], size: 92, media: {src: 'index/p_doubles.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'stat', stat: {pre: 'Roughly every', value: 7, post: 'years'}, media: {src: 'index/p_7yr.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'text', enter: 'slideL', text: '$10K to $20K,|then $40K.', highlights: ['$40k'], size: 78, media: {src: 'index/p_grow.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', text: 'Without adding|a cent.', highlights: ['cent'], size: 82, media: {src: 'index/p_cent.jpg', type: 'img', effect: 'in'}},
  {dur: 83, kind: 'text', text: 'The average hides|wild years.', highlights: ['wild'], size: 78, media: {src: 'index/p_wild.jpg', type: 'img', effect: 'in'}},
  {dur: 24, kind: 'text', text: 'Here\'s|the catch.', highlights: ['catch'], size: 92, media: {src: 'index/p_catch.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'text', text: 'Over fifteen|years.', highlights: ['fifteen'], size: 86, media: {src: 'index/p_fifteen.jpg', type: 'img', effect: 'in'}},
  {dur: 75, kind: 'stat', stat: {pre: 'Of pro funds', value: 90, suffix: '%', post: 'fail to beat it'}, media: {src: 'index/p_90.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'text', enter: 'slideR', text: 'They can\'t beat|a simple index.', highlights: ['index'], size: 78, media: {src: 'index/p_fail.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', text: 'The experts|mostly trail it.', highlights: ['trail'], size: 80, media: {src: 'index/p_trail.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', text: 'You don\'t win|by being clever.', highlights: ['clever'], size: 78, media: {src: 'index/p_clever.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', enter: 'zoom', text: 'You win by|staying in.', highlights: ['staying'], size: 84, media: {src: 'index/p_stayin.jpg', type: 'img', effect: 'in'}},
  {dur: 29, kind: 'text', text: 'The horizon does|the lifting.', highlights: ['horizon'], size: 78, media: {src: 'index/p_horizon.jpg', type: 'img', effect: 'in'}},
  {dur: 106, kind: 'text', enter: 'zoom', text: 'The enemy is|impatience.', highlights: ['impatience'], size: 82, media: {src: 'index/p_impatience.jpg', type: 'img', effect: 'in'}},
  {dur: 53, kind: 'text', text: 'It was always|available.', highlights: ['always'], size: 82, media: {src: 'index/p_available.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'impact', text: 'The hard part|was sitting still.', redBg: true},
  {dur: 107, kind: 'compare', compare: {a: {value: 10, suffix: '%', label: 'the return'}, b: {value: 90, suffix: '%', label: 'the pros, behind'}, note: 'Available for 100 years'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 222, src: 'media/sfx_whoosh.mp3', vol: 0.32}, // cut into "the broad US market"
  {at: 322, src: 'media/sfx_impact.mp3', vol: 0.5}, // 10%
  {at: 382, src: 'media/sfx_impact.mp3', vol: 0.45}, // 7%
  {at: 821, src: 'media/sfx_impact.mp3', vol: 0.55}, // 90%
  {at: 1360, src: 'media/sfx_impact.mp3', vol: 0.62}, // sitting still
  {at: 1428, src: 'media/sfx_impact.mp3', vol: 0.5}, // closing compare
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The return was always there</span>
      </div>
...
// ---------------------------------------------------------------------------
export const IndexReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('index/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('index/music.mp3')}
