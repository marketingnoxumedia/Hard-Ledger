...
// ---------------------------------------------------------------------------
// "It was a reasonable no" reel — the Blockbuster/Netflix story. Around 2000 a
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The reasonable no</span>
      </div>
...
// ---------------------------------------------------------------------------
export const BlockbusterReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('block/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('block/music.mp3')}
