...
// ---------------------------------------------------------------------------
// "The 3-week reversal" reel — Netflix's 2011 Qwikster fiasco: it split DVD and
// streaming, raised prices and renamed the DVD side, watched subscribers revolt,
// then killed the plan, admitted the mistake, and refocused — all in ~3 weeks,
// before a decade of growth. Durations placed on exact spoken-word timestamps
// (ElevenLabs alignment) at +6% pace. Total 1561 frames = ~52s. Mixes video
// clips with stills. The red `impact` card ("reversing fast is a skill") sits
// near the end; the reel closes on a calendar recap ("three weeks"), not the red
// card. Every scene uses a distinct background sourced fresh for this reel — no
// footage shared with any other reel (see the skill's hard rule).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 53, kind: 'hook', text: 'The company that|buried Blockbuster.', kicker: 'The 3-week reversal', highlights: ['buried'], size: 78, media: {src: 'qwikster/clip_tv.mp4', type: 'video', effect: 'in'}},
  {dur: 95, kind: 'text', text: 'Then nearly buried|itself, in 2011.', highlights: ['itself'], size: 78, media: {src: 'qwikster/p_5202925.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'A decision it announced…|then watched implode.', highlights: ['implode'], size: 72, media: {src: 'qwikster/p_7433849.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', text: '…and then|took back.', highlights: ['back'], size: 90, media: {src: 'qwikster/p_9900008.jpg', type: 'img', effect: 'in'}},
  {dur: 122, kind: 'text', enter: 'slideL', text: 'It split DVD-by-mail|from streaming,|and raised prices.', highlights: ['split'], size: 72, media: {src: 'qwikster/p_14213112.jpg', type: 'img', effect: 'panL'}},
  {dur: 79, kind: 'text', text: 'It spun the|DVD side off.', highlights: ['off'], size: 82, media: {src: 'qwikster/clip_disc.mp4', type: 'video', effect: 'in'}},
  {dur: 17, kind: 'text', text: 'Qwikster.', highlights: ['Qwikster'], size: 130},
  {dur: 45, kind: 'text', text: 'The strategy|wasn\'t wrong.', highlights: ['wasn\'t'], size: 84, media: {src: 'qwikster/p_7648468.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', enter: 'slideR', text: 'Separating a dying|DVD business…', highlights: ['dying'], size: 76, media: {src: 'qwikster/p_4734714.jpg', type: 'img', effect: 'in'}},
  {dur: 88, kind: 'text', text: '…is what happened|anyway.', highlights: ['anyway'], size: 84, media: {src: 'qwikster/p_4009402.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'What it got wrong|was the experience.', highlights: ['experience'], size: 76, media: {src: 'qwikster/p_52608.jpg', type: 'img', effect: 'in'}},
  {dur: 81, kind: 'text', text: 'Two websites.|Two bills.', highlights: ['two'], size: 90, media: {src: 'qwikster/p_35490296.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'A price rise|and a new name.|All at once.', highlights: ['once'], size: 74, media: {src: 'qwikster/p_6029065.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', enter: 'zoom', text: 'Every benefit|to Netflix.', highlights: ['benefit'], size: 82, media: {src: 'qwikster/p_13806260.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'Every friction|to you.', highlights: ['friction'], size: 86, media: {src: 'qwikster/p_6028573.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'stat', stat: {pre: 'Subscribers lost', value: 800, suffix: 'K'}},
  {dur: 109, kind: 'text', text: 'The stock|plunged.', highlights: ['plunged'], size: 90, media: {src: 'qwikster/clip_crash.mp4', type: 'video', effect: 'in'}},
  {dur: 93, kind: 'text', text: 'Netflix said plainly|it had misjudged.', highlights: ['misjudged'], size: 76, media: {src: 'qwikster/p_6285073.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'stat', stat: {pre: 'The whole reversal', value: 3, post: 'weeks'}, media: {src: 'qwikster/p_29509513.jpg', type: 'img', effect: 'in'}},
  {dur: 37, kind: 'text', text: 'Then a decade|of growth.', highlights: ['decade'], size: 84, media: {src: 'qwikster/clip_growth.mp4', type: 'video', effect: 'in'}},
  {dur: 107, kind: 'impact', text: 'Reversing fast|is a skill.', redBg: true},
  {dur: 73, kind: 'text', text: 'Admit it quickly.|Don\'t defend it|out of pride.', highlights: ['pride'], size: 74, media: {src: 'qwikster/p_7433851.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', enter: 'zoom', text: 'Three weeks.|The entire correction.', highlights: ['three'], size: 78, media: {src: 'qwikster/p_29509510.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 250, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 451, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 1003, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1057, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1259, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1299, src: 'media/sfx_chaching.mp3', vol: 0.5},
  {at: 1336, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1516, src: 'media/sfx_impact.mp3', vol: 0.55},
];
...
const SceneOutro: React.FC = () => {
  ...
  const {fps} = useVideoConfig();
  const parts = [
    {t: 'Announced.', red: false},
    {t: 'Reversed.', red: false},
    {t: 'In 3 weeks.', red: true},
  ];
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center'}}>
        ...
        {parts.map((p, i) => {
          ...
          return (
            <span key={i} style={{fontFamily: HEAD, fontSize: p.red ? 150 : 116, textTransform: 'uppercase', letterSpacing: 1, color: C.ink, opacity: s, transform: `translateY(${interpolate(s, [0, 1], [34, 0])}px)`}}>
              {p.red ? (<>In <span style={{color: C.red, textShadow: SH}}>3 weeks.</span></>) : p.t}
            </span>
          );
        })}
      </div>
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The 3-week reversal</span>
      </div>
...
// ---------------------------------------------------------------------------
export const QwiksterReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('qwikster/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('qwikster/music.mp3')}
