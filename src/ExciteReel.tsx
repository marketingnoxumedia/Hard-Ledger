...
// ---------------------------------------------------------------------------
// "Distribution fades" reel — Excite passing on Google in 1999. You could have
// bought the future of search for less than the price of a house; the sellers
// even dropped their price, and the buyer still said no. The buyer was Excite, a
// top web portal; the company for sale was Google — two Stanford students with a
// noticeably better search engine. Google's founders offered ~$1M, then dropped
// to ~$750K; Excite declined, on every portal's logic of the day: traffic was the
// asset, search a commodity that just sent users away, and paying to make
// visitors leave faster looked like a bad trade — nobody yet knew the money was
// in answering the query. Google's search took over the internet; Excite faded
// into irrelevance; Alphabet grew into a company worth well over a trillion
// dollars, from a price Excite thought too high. Distribution fades; a genuinely
// better product compounds — sometimes by a factor of a million. The voiceover
// runs continuously with no dead air and scene durations sit on its exact
// spoken-word timestamps (ElevenLabs alignment) at +6% pace — total 1721 frames =
// ~57s. Full-bleed footage on nearly every beat (90s tech, founders, money,
// skylines), with only one black beat (the $750K-vs-$1T closing comparison) and
// the one red "distribution fades" impact card near the end. Every background is
// sourced fresh for this reel (hard rule).
//
// NOTE (historical, unverified): names real companies (Excite, Google, Alphabet)
// and recounts the widely-reported ~1999 episode — Google's founders reportedly
// offered to sell for around $1M then ~$750K, Excite passed, and Alphabet later
// exceeded a $1T market cap. Figures are the commonly-cited version of the story;
// rendered as written and NOT independently re-verified. Confirm before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 48, kind: 'hook', text: 'In 1999.|The future, for sale.', kicker: 'Distribution fades', highlights: ['1999'], size: 74, media: {src: 'excite/p_1999.jpg', type: 'img', effect: 'in'}},
  {dur: 35, kind: 'text', text: 'The future|of search.', highlights: ['search'], size: 86, media: {src: 'excite/p_search.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'text', text: 'For less than|a house.', highlights: ['house'], size: 82, media: {src: 'excite/p_price.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'They even|dropped it.', highlights: ['dropped'], size: 84, media: {src: 'excite/p_drop.jpg', type: 'img', effect: 'in'}},
  {dur: 46, kind: 'text', enter: 'zoom', text: 'The buyer|said no.', highlights: ['no'], size: 88, media: {src: 'excite/p_no.jpg', type: 'img', effect: 'in'}},
  {dur: 80, kind: 'text', text: 'The buyer:|Excite.', highlights: ['excite'], size: 90, media: {src: 'excite/p_portal.jpg', type: 'img', effect: 'in'}},
  {dur: 113, kind: 'text', enter: 'slideL', text: 'For sale:|Google.', highlights: ['google'], size: 96, media: {src: 'excite/p_founders.jpg', type: 'img', effect: 'in'}},
  {dur: 90, kind: 'text', text: 'A noticeably|better engine.', highlights: ['better'], size: 82, media: {src: 'excite/p_code.jpg', type: 'img', effect: 'in'}},
  {dur: 69, kind: 'stat', stat: {pre: 'Offered for', prefix: '$', value: 1, suffix: 'M'}, media: {src: 'excite/p_1m.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'stat', stat: {pre: 'Then dropped to', prefix: '$', value: 750, suffix: 'K'}, media: {src: 'excite/p_750k.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'text', text: 'Excite|declined.', highlights: ['declined'], size: 92, media: {src: 'excite/p_declined.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'text', text: 'Every portal|thought the same.', highlights: ['every'], size: 78, media: {src: 'excite/p_portallogic.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'text', enter: 'slideR', text: 'Traffic was|the asset.', highlights: ['traffic'], size: 84, media: {src: 'excite/p_traffic.jpg', type: 'img', effect: 'in'}},
  {dur: 99, kind: 'text', text: 'Search just|sent users away.', highlights: ['away'], size: 78, media: {src: 'excite/p_away.jpg', type: 'img', effect: 'in'}},
  {dur: 87, kind: 'text', text: 'It looked like|a bad trade.', highlights: ['bad'], size: 80, media: {src: 'excite/p_trade.jpg', type: 'img', effect: 'in'}},
  {dur: 108, kind: 'text', enter: 'zoom', text: 'The money was in|the answer.', highlights: ['answer'], size: 78, media: {src: 'excite/p_answer.jpg', type: 'img', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'It took over|the internet.', highlights: ['internet'], size: 82, media: {src: 'excite/p_internet.jpg', type: 'img', effect: 'in'}},
  {dur: 98, kind: 'text', text: 'Excite faded|into irrelevance.', highlights: ['faded'], size: 78, media: {src: 'excite/p_faded.jpg', type: 'img', effect: 'in'}},
  {dur: 103, kind: 'stat', stat: {pre: 'Alphabet, now worth', prefix: '$', value: 1, suffix: 'T+'}, media: {src: 'excite/p_trillion.jpg', type: 'img', effect: 'in'}},
  {dur: 20, kind: 'text', text: 'Too|high.', highlights: ['high'], size: 100, media: {src: 'excite/p_high.jpg', type: 'img', effect: 'in'}},
  {dur: 131, kind: 'impact', text: 'Distribution fades.|Product compounds.', redBg: true},
  {dur: 37, kind: 'text', text: 'By a factor|of a million.', highlights: ['million'], size: 80, media: {src: 'excite/p_million.jpg', type: 'img', effect: 'in'}},
  {dur: 111, kind: 'compare', compare: {a: {value: 750, prefix: '$', suffix: 'K', label: 'refused'}, b: {value: 1, prefix: '$', suffix: 'T', label: 'gone'}, note: 'Excite → Google'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 515, src: 'media/sfx_impact.mp3', vol: 0.45}, // $1M offered
  {at: 584, src: 'media/sfx_impact.mp3', vol: 0.45}, // dropped to $750K
  {at: 1173, src: 'media/sfx_whoosh.mp3', vol: 0.35}, // took over the internet
  {at: 1319, src: 'media/sfx_impact.mp3', vol: 0.55}, // $1T+
  {at: 1325, src: 'media/sfx_chaching.mp3', vol: 0.42},
  {at: 1442, src: 'media/sfx_impact.mp3', vol: 0.62}, // distribution fades
  {at: 1610, src: 'media/sfx_impact.mp3', vol: 0.5}, // closing compare
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Distribution fades</span>
      </div>
...
// ---------------------------------------------------------------------------
export const ExciteReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('excite/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('excite/music.mp3')}
