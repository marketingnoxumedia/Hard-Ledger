...
// ---------------------------------------------------------------------------
// "The invisible roll-up" reel — Service Corporation International. Durations
// placed on exact spoken-word timestamps (ElevenLabs alignment) at +6% pace.
// Total 1640 frames = ~54.7s. `enter` adds a transition on some cuts. The two
// "invisible" beats sit on black by design, alongside the three financial
// stats. Every scene uses a distinct background sourced fresh for this reel —
// no footage is shared with any other reel (see the skill's hard rule).
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 50, kind: 'hook', text: 'There’s a company|you’ve never|heard of.', kicker: 'The invisible roll-up', highlights: ['never'], size: 78, media: {src: 'sci/p_8986709.jpg', type: 'img', effect: 'in'}},
  {dur: 96, kind: 'stat', stat: {pre: 'It serves', value: 700, suffix: 'K', post: 'families a year'}, media: {src: 'sci/clip_candles.mp4', type: 'video', effect: 'in'}},
  {dur: 48, kind: 'text', text: 'Almost nobody|knows its name.', highlights: ['name'], size: 88},
  {dur: 72, kind: 'text', enter: 'slideL', text: 'Not an accident.|The strategy.', highlights: ['strategy'], size: 90, media: {src: 'sci/p_8441783.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Service Corporation|International.', highlights: ['international'], size: 74, media: {src: 'sci/p_27686680.jpg', type: 'img', effect: 'in'}},
  {dur: 93, kind: 'text', text: 'Funeral homes|and cemeteries|across North America.', highlights: ['cemeteries'], size: 72, media: {src: 'sci/p_18495412.jpg', type: 'img', effect: 'panL'}},
  {dur: 109, kind: 'text', enter: 'slideR', text: 'Local names you’d|never connect to|one company.', highlights: ['local'], size: 72, media: {src: 'sci/p_7237663.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'The consolidation|is invisible|by design.', highlights: ['invisible'], size: 80},
  {dur: 61, kind: 'text', text: 'The local name stays|on the building.', highlights: ['building'], size: 80, media: {src: 'sci/p_28674966.jpg', type: 'img', effect: 'in'}},
  {dur: 86, kind: 'text', text: 'Families never|comparison-shop|a national chain.', highlights: ['comparison-shop'], size: 72, media: {src: 'sci/p_13919893.jpg', type: 'img', effect: 'panR'}},
  {dur: 59, kind: 'text', text: 'Demand arrives|without marketing.', highlights: ['marketing'], size: 82, media: {src: 'sci/p_8963948.jpg', type: 'img', effect: 'in'}},
  {dur: 55, kind: 'text', text: 'And without reference|to the economy.', highlights: ['economy'], size: 80, media: {src: 'sci/p_18759200.jpg', type: 'img', effect: 'in'}},
  {dur: 117, kind: 'text', enter: 'slideL', text: 'Pre-need contracts collect|the money years|in advance.', highlights: ['years'], size: 72, media: {src: 'sci/p_261621.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'Customers fund|the business|themselves.', highlights: ['themselves'], size: 78, media: {src: 'sci/p_618158.jpg', type: 'img', effect: 'in'}},
  {dur: 68, kind: 'stat', stat: {pre: 'About', value: 1490, post: 'funeral homes'}, media: {src: 'sci/p_28574958.jpg', type: 'img', effect: 'in'}},
  {dur: 63, kind: 'stat', stat: {pre: 'And', value: 496, post: 'cemeteries'}, media: {src: 'sci/p_28525326.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'stat', stat: {pre: 'Revenue', prefix: '$', value: 4.186, decimals: 3, suffix: 'B'}},
  {dur: 76, kind: 'stat', stat: {pre: 'Operating margin', value: 22, suffix: '%', bar: 22}},
...
const SFX: SfxCue[] = [
  {at: 50, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 194, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 266, src: 'media/sfx_impact.mp3', vol: 0.45},
  {at: 415, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 857, src: 'media/sfx_whoosh.mp3', vol: 0.45},
  {at: 1035, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1166, src: 'media/sfx_chaching.mp3', vol: 0.55},
  {at: 1344, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1564, src: 'media/sfx_impact.mp3', vol: 0.72},
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The invisible roll-up</span>
      </div>
