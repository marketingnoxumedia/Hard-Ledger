...
// ---------------------------------------------------------------------------
// "Short on years, not money" reel — retirement savings. The typical American
// near retirement has about $185K saved; it sounds like enough until you see what
// it pays. That's the median balance for households nearing 65, and for most it
// only tops up other income, not a salary. Drawn down safely (a 4% withdrawal
// meant to make it last), it produces only ~$7,400 a year — about $600 a month on
// top of Social Security — enough to cover a gap for a few years, not to fund
// thirty. The figure isn't fixed by fate; it mostly tracks when saving started.
// As an illustration at an assumed 7%, the same $300 a month started at 25 reaches
// ~$790K by 65, but started at 40 only ~$245K. Same money, different runway. Most
// people near retirement aren't short on money — they're short on years. The
// voiceover runs continuously with no dead air and scene durations sit on its
// exact spoken-word timestamps (ElevenLabs alignment) at +6% pace — total 1546
// frames = ~52s. Full-bleed footage on nearly every beat (retirees, savings and
// money, calculators and charts, open roads), with only one black beat (the
// $245K-vs-$790K comparison) and the one red "short on years" impact card near
// the end. Every background is sourced fresh for this reel (hard rule).
//
// NOTE (illustration / unverified): cites the widely-reported ~$185K median
// retirement savings figure for U.S. households nearing 65 and the arithmetic of
// a 4% drawdown (~$7,400/yr). The $300/mo → ~$790K (from 25) vs ~$245K (from 40)
// projections are a worked example at an assumed 7% annual return, not a forecast.
// Rendered as written; confirm the median figure and assumptions before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 64, kind: 'hook', text: 'Near retirement,|the typical American.', kicker: 'Short on years, not money', highlights: ['retirement'], size: 72, media: {src: 'runway/p_retiree.jpg', type: 'img', effect: 'in'}},
  {dur: 104, kind: 'stat', stat: {pre: 'The median saved', prefix: '$', value: 185, suffix: 'K'}, media: {src: 'runway/p_185.jpg', type: 'img', effect: 'in'}},
  {dur: 54, kind: 'text', text: 'Until you see|what it pays.', highlights: ['pays'], size: 78, media: {src: 'runway/p_pays.jpg', type: 'img', effect: 'in'}},
  {dur: 33, kind: 'text', text: 'The median|balance.', highlights: ['median'], size: 86, media: {src: 'runway/p_median.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'Households nearing|age 65.', highlights: ['65'], size: 80, media: {src: 'runway/p_couch.jpg', type: 'img', effect: 'in'}},
  {dur: 131, kind: 'text', text: 'It tops up income,|not a salary.', highlights: ['salary'], size: 78, media: {src: 'runway/p_income.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'stat', stat: {pre: 'Drawn down safely', prefix: '$', value: 7400, suffix: '/yr', comma: true}, media: {src: 'runway/p_7400.jpg', type: 'img', effect: 'in'}},
  {dur: 30, kind: 'text', text: 'About $600|a month.', highlights: ['$600'], size: 84, media: {src: 'runway/p_grocery.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', enter: 'slideR', text: 'On top of|Social Security.', highlights: ['security'], size: 76, media: {src: 'runway/p_ss.jpg', type: 'img', effect: 'in'}},
  {dur: 52, kind: 'stat', stat: {pre: 'A safe withdrawal', value: 4, suffix: '%'}, media: {src: 'runway/p_4pct.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', text: 'Meant to|make it last.', highlights: ['last'], size: 84, media: {src: 'runway/p_last.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'Covers a gap,|a few years.', highlights: ['gap'], size: 80, media: {src: 'runway/p_gap.jpg', type: 'img', effect: 'in'}},
  {dur: 52, kind: 'stat', stat: {pre: 'Not to fund', value: 30, post: 'years of retirement'}, media: {src: 'runway/p_30yr.jpg', type: 'img', effect: 'in'}},
  {dur: 51, kind: 'text', text: 'It\'s not fixed|by fate.', highlights: ['fate'], size: 84, media: {src: 'runway/p_fate.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideL', text: 'It tracks when|you started.', highlights: ['when'], size: 80, media: {src: 'runway/p_when.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'stat', stat: {pre: 'Assumed return', value: 7, suffix: '%', post: 'illustration'}, media: {src: 'runway/p_7pct.jpg', type: 'img', effect: 'in'}},
  {dur: 90, kind: 'text', enter: 'zoom', text: 'The same $300|a month.', highlights: ['$300'], size: 80, media: {src: 'runway/p_300.jpg', type: 'img', effect: 'in'}},
  {dur: 161, kind: 'compare', compare: {a: {value: 245, prefix: '$', suffix: 'K', label: 'from 40'}, b: {value: 790, prefix: '$', suffix: 'K', label: 'from 25'}, note: 'Same $300/mo · 7%'}},
  {dur: 20, kind: 'text', text: 'Same|money.', highlights: ['same'], size: 92, media: {src: 'runway/p_same.jpg', type: 'img', effect: 'in'}},
  {dur: 67, kind: 'text', enter: 'zoom', text: 'Different|runway.', highlights: ['runway'], size: 96, media: {src: 'runway/p_runway.jpg', type: 'img', effect: 'in'}},
  {dur: 38, kind: 'text', text: 'Not short|on money.', highlights: ['money'], size: 84, media: {src: 'runway/p_money.jpg', type: 'img', effect: 'in'}},
  {dur: 29, kind: 'impact', text: 'Short on|years.', redBg: true},
  {dur: 113, kind: 'text', enter: 'zoom', text: '$185K saved.|$7,400 a year.', highlights: ['$7400'], size: 80, media: {src: 'runway/p_end.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 64, src: 'media/sfx_impact.mp3', vol: 0.5}, // $185K
  {at: 470, src: 'media/sfx_impact.mp3', vol: 0.55}, // $7,400/yr
  {at: 781, src: 'media/sfx_impact.mp3', vol: 0.45}, // 30 years
  {at: 1118, src: 'media/sfx_impact.mp3', vol: 0.55}, // the compare
  {at: 1124, src: 'media/sfx_chaching.mp3', vol: 0.42},
  {at: 1404, src: 'media/sfx_impact.mp3', vol: 0.62}, // short on years
  {at: 1433, src: 'media/sfx_impact.mp3', vol: 0.5}, // closer
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Short on years, not money</span>
      </div>
...
// ---------------------------------------------------------------------------
export const RunwayReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('runway/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('runway/music.mp3')}
