...
// ---------------------------------------------------------------------------
// "When the game changes" reel — Nokia sold close to half the world's phones at
// its peak, but leadership in handsets didn't transfer to the smartphone. Clinging
// to its own software felt like strength; adopting an outside OS meant handing
// control to a partner and admitting its software was finished — a concession a
// leader almost never makes. The iPhone and Android moved the contest to software
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>When the game changes</span>
      </div>
...
// ---------------------------------------------------------------------------
export const NokiaReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('nokia/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('nokia/music.mp3')}
