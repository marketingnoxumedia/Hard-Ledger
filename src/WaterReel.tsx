...
// ---------------------------------------------------------------------------
// "Regulation as a moat" reel — the American Water story: one business whose
// demand can't fall to zero, with no substitute and no legally-allowed
// competitor. The regulator IS the business model — rates are set to earn an
// allowed return on invested capital, so reinvesting in pipes and plants is the
// mechanism by which earnings grow. Durations placed on exact spoken-word
// timestamps (ElevenLabs alignment) at +6% pace. Total 1784 frames = ~59s.
// Mixes video clips (tap, pipes, treatment plant, reservoir) with stills. The
// red `impact` card ("regulation as a moat") sits late-mid; the reel resolves
// on quieter black/media beats and closes on a reservoir clip ("engineered, not
// won"), not the red card. Every background is sourced fresh for this reel — no
// footage shared with any other reel (see the skill's hard rule).
//
// NOTE (unverified): financials attributed to American Water (NYSE: AWK) —
// $1.137B regulated net income, adjusted EPS +8.9%, $3.2B reinvested, 7–9%
// growth — are rendered as written in the client script and have NOT been
// independently verified. Flag before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 88, kind: 'hook', text: 'Demand that can\'t|fall to zero.', kicker: 'Regulation as a moat', highlights: ['zero'], size: 82, media: {src: 'water/p_13543724.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'Not in a recession.|Not in a boom.', highlights: ['boom'], size: 74},
  {dur: 67, kind: 'text', text: 'No substitute.|No competitor.', highlights: ['competitor'], size: 84, media: {src: 'water/p_4245539.jpg', type: 'img', effect: 'in'}},
  {dur: 49, kind: 'text', enter: 'slideL', text: 'And legally,|none can arrive.', highlights: ['legally'], size: 80, media: {src: 'water/p_5712211.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'American|Water.', highlights: ['water'], size: 104, media: {src: 'water/p_35425759.jpg', type: 'img', effect: 'in'}},
  {dur: 115, kind: 'text', text: 'The largest US|water utility.', highlights: ['largest'], size: 80, media: {src: 'water/p_27490881.jpg', type: 'img', effect: 'panL'}},
  {dur: 73, kind: 'text', text: 'Serving millions|of people.', highlights: ['millions'], size: 82, media: {src: 'water/clip_tap.mp4', type: 'video', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'slideR', text: 'The regulator is|the business model.', highlights: ['regulator'], size: 72, media: {src: 'water/p_5668484.jpg', type: 'img', effect: 'in'}},
  {dur: 102, kind: 'text', text: 'Rates set to earn|an allowed return.', highlights: ['return'], size: 72, media: {src: 'water/p_30795043.jpg', type: 'img', effect: 'in'}},
  {dur: 34, kind: 'text', text: 'Pipes and|plants.', highlights: ['plants'], size: 100, media: {src: 'water/clip_pipe.mp4', type: 'video', effect: 'in'}},
  {dur: 115, kind: 'text', text: 'Spending is how|earnings grow.', highlights: ['grow'], size: 78, media: {src: 'water/p_30268012.jpg', type: 'img', effect: 'in'}},
  {dur: 130, kind: 'text', enter: 'zoom', text: 'There\'s no substitute|for water.', highlights: ['water'], size: 76, media: {src: 'water/p_7402619.jpg', type: 'img', effect: 'in'}},
  {dur: 98, kind: 'text', text: 'The network is|a legal monopoly.', highlights: ['monopoly'], size: 74, media: {src: 'water/p_32502650.jpg', type: 'img', effect: 'panR'}},
  {dur: 182, kind: 'text', text: 'Reinvesting billions|every year.', highlights: ['billions'], size: 80, media: {src: 'water/clip_plant.mp4', type: 'video', effect: 'in'}},
  {dur: 104, kind: 'stat', stat: {pre: 'Regulated net income', prefix: '$', value: 1.137, decimals: 3, suffix: 'B'}, media: {src: 'water/p_18921474.jpg', type: 'img', effect: 'in'}},
  {dur: 56, kind: 'text', text: 'Adjusted earnings|per share…', highlights: ['earnings'], size: 78},
  {dur: 51, kind: 'stat', stat: {pre: 'Adjusted EPS', prefix: '+', value: 8.9, decimals: 1, suffix: '%'}, media: {src: 'water/p_5784807.jpg', type: 'img', effect: 'in'}},
  {dur: 71, kind: 'stat', stat: {pre: 'Reinvested', prefix: '$', value: 3.2, decimals: 1, suffix: 'B'}, media: {src: 'water/p_36926327.jpg', type: 'img', effect: 'in'}},
  {dur: 40, kind: 'impact', text: 'Regulation|as a moat.', redBg: true},
  {dur: 77, kind: 'lines', text: 'Essential.|Regulated.|Monopoly.', highlights: ['monopoly'], reveal: [6, 30, 54]},
  {dur: 49, kind: 'text', text: 'A rare mix of|stability and growth.', highlights: ['growth'], size: 72, media: {src: 'water/p_28283852.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'Seven to nine|percent.', highlights: ['nine'], size: 88, media: {src: 'water/p_30268013.jpg', type: 'img', effect: 'in'}},
  {dur: 60, kind: 'text', enter: 'zoom', text: 'Engineered,|not won.', highlights: ['engineered'], size: 88, media: {src: 'water/clip_reservoir.mp4', type: 'video', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 265, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 304, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 492, src: 'media/sfx_chaching.mp3', vol: 0.45},
  {at: 957, src: 'media/sfx_whoosh.mp3', vol: 0.4},
  {at: 1055, src: 'media/sfx_impact.mp3', vol: 0.55},
  {at: 1341, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1397, src: 'media/sfx_impact.mp3', vol: 0.5},
  {at: 1448, src: 'media/sfx_impact.mp3', vol: 0.72},
  {at: 1724, src: 'media/sfx_impact.mp3', vol: 0.5},
];
...
const SceneOutro: React.FC = () => {
  ...
  const {fps} = useVideoConfig();
  const parts = [
    {t: 'Essential.', red: false},
    {t: 'Regulated.', red: false},
    {t: 'A moat.', red: true},
  ];
  return (
    <AbsoluteFill style={{justifyContent: 'center', alignItems: 'center'}}>
        ...
        {parts.map((p, i) => {
          ...
          return (
            <span key={i} style={{fontFamily: HEAD, fontSize: p.red ? 138 : 116, textTransform: 'uppercase', letterSpacing: 1, color: C.ink, opacity: s, transform: `translateY(${interpolate(s, [0, 1], [34, 0])}px)`}}>
              {p.red ? (<>A <span style={{color: C.red, textShadow: SH}}>moat.</span></>) : p.t}
            </span>
          );
        })}
      </div>
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>Regulation as a moat</span>
      </div>
...
export const WaterReel: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('water/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('water/music.mp3')}
