...
const SCENES: SceneDef[] = [
  ...
  {dur: 60, kind: 'text', text: 'Then it watched|someone build|the internet version.', highlights: ['internet'], size: 72, media: {src: 'sears/p_5632382.jpg', type: 'img', effect: 'in'}},
  ...
  {dur: 55, kind: 'text', text: '…of the model|Amazon would use.', highlights: ['Amazon'], size: 80, media: {src: 'sears/p_38195854.jpg', type: 'img', effect: 'in'}},
  ...
  {dur: 84, kind: 'text', text: 'Going online meant|undercutting itself.', highlights: ['undercutting'], size: 74, media: {src: 'sears/p_6207729.jpg', type: 'img', effect: 'in'}},
  ...
  {dur: 71, kind: 'text', text: 'Captured the future|Sears invented.', highlights: ['future'], size: 78, media: {src: 'sears/p_24862481.jpg', type: 'img', effect: 'panR'}},
