...
// ---------------------------------------------------------------------------
// "The value inside the hour" reel — the hours-worked vs productivity myth. There's
// a belief that more hours means more produced and more earned; compare whole
// countries and the numbers don't back it up. It's easy to believe — effort is the
// part you control, visible busyness looks like productivity, and hours are simple
// to count while value isn't. But across countries longer hours don't track higher
// output; several nations work fewer hours per worker and produce more per hour
// than places that grind longer. Past a point extra hours bring fatigue and
// diminishing returns — a rested worker out-produces an exhausted one on the same
// task in less time; output is capped by focus and energy, not the clock. Treating
// hours as the goal confuses effort with results; the question isn't how long it
// took, it's how much value each hour created. The lever was never the length of
// the day — it's the value inside each hour. The voiceover runs continuously with
// no dead air and scene durations sit on its exact spoken-word timestamps
// (ElevenLabs alignment) at +6% pace — total 1491 frames = ~50s. Full-bleed
// footage on nearly every beat (clocks, a flag-pinned world map, tired and rested
// workers), with only one black beat (the "value isn't" line) and the one red
// "the lever was never the length of the day" impact card near the end. Every
// background is sourced fresh for this reel (hard rule).
//
// NOTE: a general productivity explainer; states no specific figures and names no
// company. The cross-country claim (longer average hours don't track higher output
// per hour) reflects the widely-reported pattern in OECD hours-vs-productivity data
// — directional, not a precise statistic; confirm specifics before publishing.
// ---------------------------------------------------------------------------
const SCENES: SceneDef[] = [
  {dur: 106, kind: 'hook', text: 'More hours,|more output?', kicker: 'The value inside the hour', highlights: ['more'], size: 82, media: {src: 'hours/p_clock1.jpg', type: 'img', effect: 'in'}},
  {dur: 45, kind: 'text', text: 'Compare whole|countries.', highlights: ['countries'], size: 82, media: {src: 'hours/p_countries.jpg', type: 'img', effect: 'in'}},
  {dur: 42, kind: 'text', text: 'The numbers|don\'t agree.', highlights: ['numbers'], size: 84, media: {src: 'hours/p_data.jpg', type: 'img', effect: 'in'}},
  {dur: 39, kind: 'text', text: 'Easy|to believe.', highlights: ['easy'], size: 90, media: {src: 'hours/p_believe.jpg', type: 'img', effect: 'in'}},
  {dur: 66, kind: 'text', text: 'Effort is what|you control.', highlights: ['effort'], size: 80, media: {src: 'hours/p_effort.jpg', type: 'img', effect: 'in'}},
  {dur: 57, kind: 'text', enter: 'slideL', text: 'Busyness looks like|productivity.', highlights: ['busyness'], size: 76, media: {src: 'hours/p_busy.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'Hours are|easy to count.', highlights: ['count'], size: 82, media: {src: 'hours/p_clock2.jpg', type: 'img', effect: 'in'}},
  {dur: 64, kind: 'impact', text: 'Value|isn\'t.', highlights: ['value']},
  {dur: 97, kind: 'text', enter: 'slideL', text: 'Longer hours|don\'t track output.', highlights: ['longer'], size: 78, media: {src: 'hours/p_worldmap.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'Some work|fewer hours.', highlights: ['fewer'], size: 84, media: {src: 'hours/p_fewer.jpg', type: 'img', effect: 'in'}},
  {dur: 58, kind: 'text', text: 'And produce|more per hour.', highlights: ['more'], size: 82, media: {src: 'hours/p_productive.jpg', type: 'img', effect: 'in'}},
  {dur: 78, kind: 'text', text: 'Than those who|grind longer.', highlights: ['grind'], size: 80, media: {src: 'hours/p_grind.jpg', type: 'img', effect: 'in'}},
  {dur: 61, kind: 'text', text: 'Fatigue.|Diminishing returns.', highlights: ['fatigue'], size: 78, media: {src: 'hours/p_fatigue.jpg', type: 'img', effect: 'in'}},
  {dur: 109, kind: 'text', enter: 'zoom', text: 'A rested worker|out-produces.', highlights: ['rested'], size: 80, media: {src: 'hours/p_rested.jpg', type: 'img', effect: 'in'}},
  {dur: 44, kind: 'text', text: 'Same task.|Less time.', highlights: ['less'], size: 86, media: {src: 'hours/p_less.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'text', text: 'Capped by focus|and energy.', highlights: ['focus'], size: 82, media: {src: 'hours/p_energy.jpg', type: 'img', effect: 'in'}},
  {dur: 72, kind: 'text', text: 'Not by|the clock.', highlights: ['clock'], size: 90, media: {src: 'hours/p_clock3.jpg', type: 'img', effect: 'in'}},
  {dur: 70, kind: 'text', enter: 'slideR', text: 'It confuses effort|with results.', highlights: ['results'], size: 78, media: {src: 'hours/p_confuse.jpg', type: 'img', effect: 'in'}},
  {dur: 43, kind: 'text', text: 'Not how long|it took.', highlights: ['long'], size: 84, media: {src: 'hours/p_howlong.jpg', type: 'img', effect: 'in'}},
  {dur: 84, kind: 'text', enter: 'zoom', text: 'But the value|each hour made.', highlights: ['value'], size: 80, media: {src: 'hours/p_value.jpg', type: 'img', effect: 'in'}},
  {dur: 47, kind: 'impact', text: 'The lever was never|the length of the day.', redBg: true},
  {dur: 54, kind: 'text', text: 'It\'s the value|inside the hour.', highlights: ['inside'], size: 80, media: {src: 'hours/p_hour.jpg', type: 'img', effect: 'in'}},
  {dur: 118, kind: 'lines', text: 'Fewer hours.|More produced.|Across economies.', highlights: ['more'], reveal: [6, 40, 74], media: {src: 'hours/p_closer.jpg', type: 'img', effect: 'in'}},
];

// Sound-effect cues (frame, file, gain). Placed on key beats, not every cut.
type SfxCue = {at: number; src: string; vol: number};
const SFX: SfxCue[] = [
  {at: 106, src: 'media/sfx_whoosh.mp3', vol: 0.32}, // cut into "compare countries"
  {at: 402, src: 'media/sfx_impact.mp3', vol: 0.5}, // value isn't
  {at: 803, src: 'media/sfx_impact.mp3', vol: 0.45}, // a rested worker
  {at: 1272, src: 'media/sfx_impact.mp3', vol: 0.62}, // the lever was never...
  {at: 1373, src: 'media/sfx_impact.mp3', vol: 0.5}, // closer
];
  ...
  return (
    <>
      <div style={{position: 'absolute', top: 70, left: 80, display: 'flex', alignItems: 'center', gap: 14}}>
        ...
        <span style={{fontFamily: BODY, fontWeight: 700, fontSize: 22, letterSpacing: 5, color: C.ink, textTransform: 'uppercase', textShadow: SH}}>The value inside the hour</span>
      </div>
...
// ---------------------------------------------------------------------------
export const HoursReel: React.FC = () => {
  const frame = useCurrentFrame();
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.bg}}>
      {HAS_VOICEOVER ? <Audio src={staticFile('hours/voiceover.mp3')} /> : null}
      <Audio
        src={staticFile('hours/music.mp3')}
